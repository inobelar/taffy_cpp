...
TEST_CASE("justify_content_row_space_around") {
    ...
    REQUIRE_MESSAGE(location.x == 12.0f, "x of node ", Debug(node0), ". Expected ", 12.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 78.0f, "x of node ", Debug(node2), ". Expected ", 78.0f, ". Actual ", location.x);
