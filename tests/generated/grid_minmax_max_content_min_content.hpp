...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_max_content_min_content.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_max_content_min_content") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { minmax<TrackSizingFunction>(max_content<MinTrackSizingFunction>(), min_content<MaxTrackSizingFunction>()) };}),
            mkVec(node0)
        )
        .unwrap();
