...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_items_sized_end.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_items_sized_end") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.align_items = Some(AlignItems::End);
