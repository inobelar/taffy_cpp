...
// ATTENTION: GENERATED FROM: taffy/tests/generated/rounding_flex_basis_overrides_main_size.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("rounding_flex_basis_overrides_main_size") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.size = Size<Dimension> { Dimension::Length(100.0f), Dimension::Length(113.0f) };}),
    ...
    REQUIRE_MESSAGE(size.height == 64.0f, "height of node ", Debug(node0), ". Expected ", 64.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.y == 64.0f, "y of node ", Debug(node1), ". Expected ", 64.0f, ". Actual ", location.y);
