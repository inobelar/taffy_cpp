...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_last_child_collapse_positive_equal.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_last_child_collapse_positive_equal") {
