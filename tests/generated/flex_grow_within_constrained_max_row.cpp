/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/flex_grow_within_constrained_max_row.rs !
...
TEST_CASE("flex_grow_within_constrained_max_row") {
    ...
    REQUIRE_MESSAGE(size.width == 67.0f, "width of node ", Debug(node00), ". Expected ", 67.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 33.0f, "width of node ", Debug(node01), ". Expected ", 33.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node01), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 67.0f, "x of node ", Debug(node01), ". Expected ", 67.0f, ". Actual ", location.x);
