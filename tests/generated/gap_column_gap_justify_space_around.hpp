...
TEST_CASE("gap_column_gap_justify_space_around") {
    ...
    REQUIRE(location.x == 3.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 3.0f, location.x
    ...
    REQUIRE(location.x == 77.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 77.0f, location.x
