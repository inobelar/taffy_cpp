...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_fr_single_item_indefinite.rs !
...
TEST_CASE("grid_fr_single_item_indefinite") {
    ...
    REQUIRE_MESSAGE(size.width == 240.0f, "width of node ", Debug(node), ". Expected ", 240.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 100.0f, "width of node ", Debug(node8), ". Expected ", 100.0f, ". Actual ", size.width);
