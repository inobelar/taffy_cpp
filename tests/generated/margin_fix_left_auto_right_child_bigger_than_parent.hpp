...
// ATTENTION: GENERATED FROM: taffy/tests/generated/margin_fix_left_auto_right_child_bigger_than_parent.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("margin_fix_left_auto_right_child_bigger_than_parent") {
    ...
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.margin = Rect<LengthPercentageAuto> { LengthPercentageAuto::Length(10.0f), LengthPercentageAuto::Auto(), zero<LengthPercentageAuto>(), zero<LengthPercentageAuto>() };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 42.0f, "width of node ", Debug(node0), ". Expected ", 42.0f, ". Actual ", size.width);
