...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_child_with_margin_x.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_child_with_margin_x") {
    ...
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.position = Position::Absolute();
            s.size = Size<Dimension> { Dimension::Length(9.0f), Dimension::Length(9.0f) };
            s.margin = Rect<LengthPercentageAuto> { zero<LengthPercentageAuto>(), LengthPercentageAuto::Length(7.0f), zero<LengthPercentageAuto>(), zero<LengthPercentageAuto>() };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 9.0f, "width of node ", Debug(node1), ". Expected ", 9.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 9.0f, "height of node ", Debug(node1), ". Expected ", 9.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.width == 9.0f, "width of node ", Debug(node2), ". Expected ", 9.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 9.0f, "height of node ", Debug(node2), ". Expected ", 9.0f, ". Actual ", size.height);
