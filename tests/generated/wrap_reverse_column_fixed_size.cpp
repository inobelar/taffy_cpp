/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/wrap_reverse_column_fixed_size.rs !
...
TEST_CASE("wrap_reverse_column_fixed_size") {
    ...
    REQUIRE_MESSAGE(location.x == 135.0f, "x of node ", Debug(node0), ". Expected ", 135.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 135.0f, "x of node ", Debug(node1), ". Expected ", 135.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.y == 30.0f, "y of node ", Debug(node2), ". Expected ", 30.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 135.0f, "x of node ", Debug(node3), ". Expected ", 135.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 35.0f, "x of node ", Debug(node4), ". Expected ", 35.0f, ". Actual ", location.x);
