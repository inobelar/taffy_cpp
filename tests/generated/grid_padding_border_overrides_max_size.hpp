...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_padding_border_overrides_max_size.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_padding_border_overrides_max_size") {
    ...
    const auto node = taffy
        .new_with_children(StyleBuilder([&](Style& s) { s.display = Display::Grid();}), mkVec(node0))
        .unwrap();
