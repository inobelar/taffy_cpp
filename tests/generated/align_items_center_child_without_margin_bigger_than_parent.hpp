...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_items_center_child_without_margin_bigger_than_parent.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("align_items_center_child_without_margin_bigger_than_parent") {
    ...
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) { s.align_items = Some(AlignItems::Center);}),
            mkVec(node00)
        )
        .unwrap();
    ...
    REQUIRE(size.height == 70.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 70.0f, size.height
    ...
    REQUIRE(size.height == 70.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node00, 70.0f, size.height
