...
// ATTENTION: GENERATED FROM: taffy/tests/generated/flex_basis_flex_grow_row.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("flex_basis_flex_grow_row") {
    ...
    REQUIRE_MESSAGE(size.width == 75.0f, "width of node ", Debug(node0), ". Expected ", 75.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 25.0f, "width of node ", Debug(node1), ". Expected ", 25.0f, ". Actual ", size.width);
