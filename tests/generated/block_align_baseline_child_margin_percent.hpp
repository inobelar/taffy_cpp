...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_align_baseline_child_margin_percent.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_align_baseline_child_margin_percent") {
    ...
    REQUIRE(location.y == 35.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 35.0f, location.y
    ...
    REQUIRE(location.x == 1.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node10, 1.0f, location.x
    REQUIRE(location.y == 1.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node10, 1.0f, location.y
}
