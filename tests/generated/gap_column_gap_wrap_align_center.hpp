...
// ATTENTION: GENERATED FROM: taffy/tests/generated/gap_column_gap_wrap_align_center.rs ! DO NOT EDIT BY HAND !

TEST_CASE("gap_column_gap_wrap_align_center") {
    ...
    REQUIRE_MESSAGE(location.y == 60.0f, "y of node ", Debug(node5), ". Expected ", 60.0f, ". Actual ", location.y);
}
