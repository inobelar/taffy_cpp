...
TEST_CASE("percentage_different_width_height_column") {
    ...
    REQUIRE(size.height == 210.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 210.0f, size.height
    ...
    REQUIRE(location.y == 210.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 210.0f, location.y
}
