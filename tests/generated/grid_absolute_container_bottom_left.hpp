...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_bottom_left.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_bottom_left") {
    ...
    REQUIRE_MESSAGE(location.y == 160.0f, "y of node ", Debug(node0), ". Expected ", 160.0f, ". Actual ", location.y);
