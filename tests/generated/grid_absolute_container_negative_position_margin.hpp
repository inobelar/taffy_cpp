...
TEST_CASE("grid_absolute_container_negative_position_margin") {
    ...
    REQUIRE_MESSAGE(location.x == 193.0f, "x of node ", Debug(node0), ". Expected ", 193.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.y == 182.0f, "y of node ", Debug(node1), ". Expected ", 182.0f, ". Actual ", location.y);
