...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_negative_position_margin.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_negative_position_margin") {
    ...
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.inset = Rect<LengthPercentageAuto> { Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(-15.0f), LengthPercentageAuto::Length(-5.0f), Auto<LengthPercentageAuto>() };}))
        .unwrap();
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.position = Position::Absolute();
            s.margin = Rect<LengthPercentageAuto> { LengthPercentageAuto::Length(4.0f), LengthPercentageAuto::Length(2.0f), LengthPercentageAuto::Length(1.0f), LengthPercentageAuto::Length(3.0f) };
            s.inset = Rect<LengthPercentageAuto> { LengthPercentageAuto::Length(-35.0f), Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(-25.0f) };}))
        .unwrap();
    ...
    REQUIRE(location.x == 193.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 193.0f, location.x
    ...
    REQUIRE(location.y == 182.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 182.0f, location.y
    ...
    REQUIRE(location.y == 10.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node4, 10.0f, location.y
    ...
    REQUIRE(location.y == 50.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node7, 50.0f, location.y
    ...
    REQUIRE(location.x == 40.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node8, 40.0f, location.x
