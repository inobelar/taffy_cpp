...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_first_child_collapse_blocked_by_overflow_x_scroll.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_first_child_collapse_blocked_by_overflow_x_scroll") {
    ...
    REQUIRE_MESSAGE(size.height == 35.0f, "height of node ", Debug(node0), ". Expected ", 35.0f, ". Actual ", size.height);
