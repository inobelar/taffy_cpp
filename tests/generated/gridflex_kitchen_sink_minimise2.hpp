...
// ATTENTION: GENERATED FROM: taffy/tests/generated/gridflex_kitchen_sink_minimise2.rs ! DO NOT EDIT BY HAND !

TEST_CASE("gridflex_kitchen_sink_minimise2") {
    ...
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_rows = GridTrackVec<TrackSizingFunction> { Auto<TrackSizingFunction>() };
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { Auto<TrackSizingFunction>() };}),
            mkVec(node00)
        )
        .unwrap();
