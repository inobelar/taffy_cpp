...
TEST_CASE("rounding_fractial_input_2") {
    ...
    REQUIRE_MESSAGE(size.height == 114.0f, "height of node ", Debug(node), ". Expected ", 114.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 65.0f, "height of node ", Debug(node0), ". Expected ", 65.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 24.0f, "height of node ", Debug(node1), ". Expected ", 24.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 25.0f, "height of node ", Debug(node2), ". Expected ", 25.0f, ". Actual ", size.height);
