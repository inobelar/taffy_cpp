...
// ATTENTION: GENERATED FROM: taffy/tests/generated/rounding_fractial_input_2.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("rounding_fractial_input_2") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.size = Size<Dimension> { Dimension::Length(100.0f), Dimension::Length(113.6f) };}),
    ...
    REQUIRE(size.height == 114.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node, 114.0f, size.height
    ...
    REQUIRE(size.height == 65.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 65.0f, size.height
    ...
    REQUIRE(size.height == 24.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 24.0f, size.height
    REQUIRE(location.x == 0.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 0.0f, location.x
    REQUIRE(location.y == 65.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 65.0f, location.y
    { const Layout& l = taffy.layout(node2).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE(size.width == 100.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node2, 100.0f, size.width
    REQUIRE(size.height == 25.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node2, 25.0f, size.height
