...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_repeat_mixed.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_repeat_mixed") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_rows = GridTrackVec<TrackSizingFunction> { 
                    length<TrackSizingFunction>(40.0f),
                    repeat(GridTrackRepetition::Count(1), Vec<NonRepeatedTrackSizingFunction>{ length<NonRepeatedTrackSizingFunction>(40.0f) } ),
                    repeat(GridTrackRepetition::AutoFill(), Vec<NonRepeatedTrackSizingFunction>{ length<NonRepeatedTrackSizingFunction>(40.0f) } ),
                 };
