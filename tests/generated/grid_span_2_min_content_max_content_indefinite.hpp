...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_span_2_min_content_max_content_indefinite.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_span_2_min_content_max_content_indefinite") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { min_content<TrackSizingFunction>(), max_content<TrackSizingFunction>() };}),
