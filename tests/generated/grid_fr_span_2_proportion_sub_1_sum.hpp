...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_fr_span_2_proportion_sub_1_sum.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_fr_span_2_proportion_sub_1_sum") {
    ...
    REQUIRE(location.x == 24.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 24.0f, location.x
