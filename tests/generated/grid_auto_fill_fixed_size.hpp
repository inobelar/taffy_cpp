...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_auto_fill_fixed_size.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_auto_fill_fixed_size") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { length<TrackSizingFunction>(40.0f), repeat(GridTrackRepetition::AutoFill(), Vec<NonRepeatedTrackSizingFunction>{ length<NonRepeatedTrackSizingFunction>(40.0f) } ) };
