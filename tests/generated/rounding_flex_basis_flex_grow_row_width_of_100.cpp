/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/rounding_flex_basis_flex_grow_row_width_of_100.rs !
...
TEST_CASE("rounding_flex_basis_flex_grow_row_width_of_100") {
    ...
    REQUIRE_MESSAGE(size.width == 34.0f, "width of node ", Debug(node1), ". Expected ", 34.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node1), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 33.0f, "x of node ", Debug(node1), ". Expected ", 33.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 67.0f, "x of node ", Debug(node2), ". Expected ", 67.0f, ". Actual ", location.x);
