...
// ATTENTION: GENERATED FROM: taffy/tests/generated/flex_basis_slightly_smaller_then_content_with_flex_grow_large_size.rs ! DO NOT EDIT BY HAND !

TEST_CASE("flex_basis_slightly_smaller_then_content_with_flex_grow_large_size") {
    ...
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.flex_grow = 1.0f;
                s.flex_basis = Dimension::Length(60.0f);}),
            mkVec(node00)
        )
        .unwrap();
