...
// ATTENTION: GENERATED FROM: taffy/tests/generated/blockflex_block_in_flex_column.rs ! DO NOT EDIT BY HAND !

TEST_CASE("blockflex_block_in_flex_column") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.size = Size<Dimension> { Dimension::Length(200.0f), Dimension::Length(50.0f) };}),
            mkVec(node0, node1)
        )
        .unwrap();
