...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_first_child_collapse_blocked_by_overflow_y_hidden.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_first_child_collapse_blocked_by_overflow_y_hidden") {
    ...
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                s.display = Display::Block();
                s.overflow = Point<Overflow> { Overflow::Visible(), Overflow::Hidden() };
