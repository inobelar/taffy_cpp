...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_justify_content_space_around.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_justify_content_space_around") {
    ...
    REQUIRE(location.x == 147.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 147.0f, location.x
    ...
    REQUIRE(location.x == 13.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node3, 13.0f, location.x
    ...
    REQUIRE(location.x == 147.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node5, 147.0f, location.x
    ...
    REQUIRE(location.x == 13.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node6, 13.0f, location.x
    ...
    REQUIRE(location.x == 147.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node8, 147.0f, location.x
