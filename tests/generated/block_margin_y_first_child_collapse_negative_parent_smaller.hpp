...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_first_child_collapse_negative_parent_smaller.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_first_child_collapse_negative_parent_smaller") {
