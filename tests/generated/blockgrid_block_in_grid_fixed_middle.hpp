...
// ATTENTION: GENERATED FROM: taffy/tests/generated/blockgrid_block_in_grid_fixed_middle.rs ! DO NOT EDIT BY HAND !

TEST_CASE("blockgrid_block_in_grid_fixed_middle") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { length<TrackSizingFunction>(30.0f) };}),
            mkVec(node0, node1)
        )
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 30.0f, "width of node ", Debug(node), ". Expected ", 30.0f, ". Actual ", size.width);
