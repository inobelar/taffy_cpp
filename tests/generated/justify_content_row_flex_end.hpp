...
// ATTENTION: GENERATED FROM: taffy/tests/generated/justify_content_row_flex_end.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("justify_content_row_flex_end") {
    ...
    REQUIRE_MESSAGE(location.x == 90.0f, "x of node ", Debug(node2), ". Expected ", 90.0f, ". Actual ", location.x);
