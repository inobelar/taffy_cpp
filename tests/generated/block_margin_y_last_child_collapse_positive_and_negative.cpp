/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_last_child_collapse_positive_and_negative.rs !
...
TEST_CASE("block_margin_y_last_child_collapse_positive_and_negative") {
    ...
    REQUIRE_MESSAGE(location.y == 15.0f, "y of node ", Debug(node2), ". Expected ", 15.0f, ". Actual ", location.y);
