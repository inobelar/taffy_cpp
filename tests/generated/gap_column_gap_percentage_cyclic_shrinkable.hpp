...
TEST_CASE("gap_column_gap_percentage_cyclic_shrinkable") {
    ...
    REQUIRE(size.width == 12.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node1, 12.0f, size.width
    REQUIRE(size.height == 40.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 40.0f, size.height
    REQUIRE(location.x == 24.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 24.0f, location.x
    REQUIRE(location.y == 0.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 0.0f, location.y
    { const Layout& l = taffy.layout(node2).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE(size.width == 12.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node2, 12.0f, size.width
    REQUIRE(size.height == 40.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node2, 40.0f, size.height
    REQUIRE(location.x == 48.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 48.0f, location.x
