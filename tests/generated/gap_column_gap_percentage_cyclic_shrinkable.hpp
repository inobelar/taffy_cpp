...
// ATTENTION: GENERATED FROM: taffy/tests/generated/gap_column_gap_percentage_cyclic_shrinkable.rs ! DO NOT EDIT BY HAND !

TEST_CASE("gap_column_gap_percentage_cyclic_shrinkable") {
    ...
    REQUIRE_MESSAGE(size.width == 12.0f, "width of node ", Debug(node1), ". Expected ", 12.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 40.0f, "height of node ", Debug(node1), ". Expected ", 40.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 24.0f, "x of node ", Debug(node1), ". Expected ", 24.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 0.0f, "y of node ", Debug(node1), ". Expected ", 0.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node2).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 12.0f, "width of node ", Debug(node2), ". Expected ", 12.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 40.0f, "height of node ", Debug(node2), ". Expected ", 40.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 48.0f, "x of node ", Debug(node2), ". Expected ", 48.0f, ". Actual ", location.x);
