...
// ATTENTION: GENERATED FROM: taffy/tests/generated/blockgrid_block_in_grid_fr.rs ! DO NOT EDIT BY HAND !

TEST_CASE("blockgrid_block_in_grid_fr") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { fr<TrackSizingFunction>(1.0f) };}),
            mkVec(node0, node1)
        )
        .unwrap();
