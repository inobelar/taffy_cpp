/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/align_flex_start_with_stretching_children.rs !
...
TEST_CASE("align_flex_start_with_stretching_children") {
    ...
    REQUIRE_MESSAGE(size.height == 500.0f, "height of node ", Debug(node00), ". Expected ", 500.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 500.0f, "height of node ", Debug(node000), ". Expected ", 500.0f, ". Actual ", size.height);
