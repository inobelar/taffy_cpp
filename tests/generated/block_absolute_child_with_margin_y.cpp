/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_child_with_margin_y.rs !
...
TEST_CASE("block_absolute_child_with_margin_y") {
    ...
    REQUIRE_MESSAGE(location.y == 7.0f, "y of node ", Debug(node0), ". Expected ", 7.0f, ". Actual ", location.y);
