...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_content_space_evenly.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_content_space_evenly") {
    ...
    REQUIRE(location.y == 140.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node6, 140.0f, location.y
    ...
    REQUIRE(location.y == 140.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node7, 140.0f, location.y
    ...
    REQUIRE(location.y == 140.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node8, 140.0f, location.y
}
