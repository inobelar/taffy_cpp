...
TEST_CASE("grid_align_content_space_evenly") {
    ...
    REQUIRE_MESSAGE(location.y == 140.0f, "y of node ", Debug(node6), ". Expected ", 140.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 140.0f, "y of node ", Debug(node7), ". Expected ", 140.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 140.0f, "y of node ", Debug(node8), ". Expected ", 140.0f, ". Actual ", location.y);
}
