...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_x_percentage_fixed_size_negative.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_x_percentage_fixed_size_negative") {
    ...
    REQUIRE_MESSAGE(size.width == 65.0f, "width of node ", Debug(node0), ". Expected ", 65.0f, ". Actual ", size.width);
