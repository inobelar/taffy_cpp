...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_x_percentage_intrinsic_size_other_negative.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_x_percentage_intrinsic_size_other_negative") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(10.0f) };
            s.margin = Rect<LengthPercentageAuto> { LengthPercentageAuto::Percent(-0.2f), LengthPercentageAuto::Percent(-0.1f), zero<LengthPercentageAuto>(), zero<LengthPercentageAuto>() };}))
        .unwrap();
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.size = Size<Dimension> { Dimension::Length(100.0f), Dimension::Length(10.0f) };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 130.0f, "width of node ", Debug(node0), ". Expected ", 130.0f, ". Actual ", size.width);
