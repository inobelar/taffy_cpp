...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_aspect_ratio_child_fill_content_height.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_aspect_ratio_child_fill_content_height") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style& s) { s.aspect_ratio = Some(0.5f);}),
