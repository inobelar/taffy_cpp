...
// ATTENTION: GENERATED FROM: taffy/tests/generated/gap_column_gap_determines_parent_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("gap_column_gap_determines_parent_width") {
    ...
    const auto node2 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.size = Size<Dimension> { Dimension::Length(30.0f), Auto<Dimension>() };}))
        .unwrap();
