...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_aspect_ratio_absolute_aspect_ratio_overrides_height_of_full_inset.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_aspect_ratio_absolute_aspect_ratio_overrides_height_of_full_inset") {
    ...
    REQUIRE_MESSAGE(size.width == 360.0f, "width of node ", Debug(node0), ". Expected ", 360.0f, ". Actual ", size.width);
