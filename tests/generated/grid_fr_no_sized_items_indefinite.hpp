...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_fr_no_sized_items_indefinite.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_fr_no_sized_items_indefinite") {
    ...
    REQUIRE(size.width == 0.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node5, 0.0f, size.width
    ...
    REQUIRE(size.width == 0.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node7, 0.0f, size.width
    ...
    REQUIRE(size.width == 0.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node8, 0.0f, size.width
