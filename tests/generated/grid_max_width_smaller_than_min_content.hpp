...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_max_width_smaller_than_min_content.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_max_width_smaller_than_min_content") {
    ...
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.max_size = Size<Dimension> { Dimension::Length(60.0f), Auto<Dimension>() };}),
            mkVec(node00, node01)
        )
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.x == 40.0f, "x of node ", Debug(node01), ". Expected ", 40.0f, ". Actual ", location.x);
