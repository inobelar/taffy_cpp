...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_content_space_evenly_with_padding_border.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_content_space_evenly_with_padding_border") {
    ...
    REQUIRE_MESSAGE(location.y == 116.0f, "y of node ", Debug(node6), ". Expected ", 116.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 116.0f, "y of node ", Debug(node7), ". Expected ", 116.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 116.0f, "y of node ", Debug(node8), ". Expected ", 116.0f, ". Actual ", location.y);
}
