...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_stretch_should_size_based_on_parent.rs ! DO NOT EDIT BY HAND !

TEST_CASE("align_stretch_should_size_based_on_parent") {
    ...
    REQUIRE_MESSAGE(size.height == 20.0f, "height of node ", Debug(node000), ". Expected ", 20.0f, ". Actual ", size.height);
