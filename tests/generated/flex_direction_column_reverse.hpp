...
// ATTENTION: GENERATED FROM: taffy/tests/generated/flex_direction_column_reverse.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("flex_direction_column_reverse") {
    ...
    REQUIRE_MESSAGE(location.y == 70.0f, "y of node ", Debug(node2), ". Expected ", 70.0f, ". Actual ", location.y);
}
