...
// ATTENTION: GENERATED FROM: taffy/tests/generated/min_height_overrides_max_height.rs ! DO NOT EDIT BY HAND !

TEST_CASE("min_height_overrides_max_height") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.min_size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(100.0f) };
            s.max_size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(50.0f) };}))
        .unwrap();
