...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_display_none_with_child.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_display_none_with_child") {
    ...
    const auto node1 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) { s.display = Display::None();}),
            mkVec(node10)
        )
        .unwrap();
