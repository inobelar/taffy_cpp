...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_span_2_max_content_max_content_indefinite.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_span_2_max_content_max_content_indefinite") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { max_content<TrackSizingFunction>(), max_content<TrackSizingFunction>() };}),
