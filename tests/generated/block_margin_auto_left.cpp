/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_auto_left.rs !
...
TEST_CASE("block_margin_auto_left") {
    ...
    REQUIRE_MESSAGE(location.x == 150.0f, "x of node ", Debug(node0), ". Expected ", 150.0f, ". Actual ", location.x);
