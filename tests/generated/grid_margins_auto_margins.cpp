...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_margins_auto_margins.rs !
...
TEST_CASE("grid_margins_auto_margins") {
    ...
    REQUIRE_MESSAGE(location.x == 130.0f, "x of node ", Debug(node2), ". Expected ", 130.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.y == 60.0f, "y of node ", Debug(node4), ". Expected ", 60.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 50.0f, "x of node ", Debug(node6), ". Expected ", 50.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 100.0f, "y of node ", Debug(node6), ". Expected ", 100.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 120.0f, "x of node ", Debug(node8), ". Expected ", 120.0f, ". Actual ", location.x);
