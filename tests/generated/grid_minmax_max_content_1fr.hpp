...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_max_content_1fr.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_max_content_1fr") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { minmax<TrackSizingFunction>(max_content<MinTrackSizingFunction>(), fr<MaxTrackSizingFunction>(1.0f)) };}),
            mkVec(node0)
        )
        .unwrap();
