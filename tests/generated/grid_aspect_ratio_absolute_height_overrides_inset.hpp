...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_aspect_ratio_absolute_height_overrides_inset.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_aspect_ratio_absolute_height_overrides_inset") {
    ...
    REQUIRE(size.width == 90.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node0, 90.0f, size.width
