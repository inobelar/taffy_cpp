/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/align_content_spacearound.rs !
...
TEST_CASE("align_content_spacearound") {
    ...
    REQUIRE_MESSAGE(location.y == 55.0f, "y of node ", Debug(node3), ". Expected ", 55.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 95.0f, "y of node ", Debug(node4), ". Expected ", 95.0f, ". Actual ", location.y);
}
