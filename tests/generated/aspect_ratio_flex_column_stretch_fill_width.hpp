...
// ATTENTION: GENERATED FROM: taffy/tests/generated/aspect_ratio_flex_column_stretch_fill_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("aspect_ratio_flex_column_stretch_fill_width") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(40.0f) };
