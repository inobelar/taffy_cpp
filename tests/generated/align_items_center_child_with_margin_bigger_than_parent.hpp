...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_items_center_child_with_margin_bigger_than_parent.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("align_items_center_child_with_margin_bigger_than_parent") {
    ...
    REQUIRE_MESSAGE(location.x == 10.0f, "x of node ", Debug(node00), ". Expected ", 10.0f, ". Actual ", location.x);
