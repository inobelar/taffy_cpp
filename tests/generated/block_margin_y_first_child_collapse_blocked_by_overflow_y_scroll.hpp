...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_first_child_collapse_blocked_by_overflow_y_scroll.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_first_child_collapse_blocked_by_overflow_y_scroll") {
    ...
    REQUIRE_MESSAGE(size.width == 35.0f, "width of node ", Debug(node00), ". Expected ", 35.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 35.0f, "width of node ", Debug(node000), ". Expected ", 35.0f, ". Actual ", size.width);
