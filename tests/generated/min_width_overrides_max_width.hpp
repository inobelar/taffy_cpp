...
// ATTENTION: GENERATED FROM: taffy/tests/generated/min_width_overrides_max_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("min_width_overrides_max_width") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.min_size = Size<Dimension> { Dimension::Length(100.0f), Auto<Dimension>() };
            s.max_size = Size<Dimension> { Dimension::Length(50.0f), Auto<Dimension>() };}))
        .unwrap();
