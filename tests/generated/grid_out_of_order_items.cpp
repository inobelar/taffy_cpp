...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_out_of_order_items.rs !
...
TEST_CASE("grid_out_of_order_items") {
    ...
    REQUIRE_MESSAGE(location.x == 80.0f, "x of node ", Debug(node0), ". Expected ", 80.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.width == 35.0f, "width of node ", Debug(node2), ". Expected ", 35.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 35.0f, "height of node ", Debug(node2), ". Expected ", 35.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.width == 10.0f, "width of node ", Debug(node7), ". Expected ", 10.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 10.0f, "height of node ", Debug(node7), ". Expected ", 10.0f, ". Actual ", size.height);
