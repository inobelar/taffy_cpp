...
// ATTENTION: GENERATED FROM: taffy/tests/generated/flex_basis_flex_shrink_column.rs ! DO NOT EDIT BY HAND !

TEST_CASE("flex_basis_flex_shrink_column") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) { s.flex_basis = Dimension::Length(100.0f);}))
        .unwrap();
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) { s.flex_basis = Dimension::Length(50.0f);}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.height == 33.0f, "height of node ", Debug(node1), ". Expected ", 33.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node1), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 67.0f, "y of node ", Debug(node1), ". Expected ", 67.0f, ". Actual ", location.y);
}
