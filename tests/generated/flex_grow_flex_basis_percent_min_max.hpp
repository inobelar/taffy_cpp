...
// ATTENTION: GENERATED FROM: taffy/tests/generated/flex_grow_flex_basis_percent_min_max.rs ! DO NOT EDIT BY HAND !

TEST_CASE("flex_grow_flex_basis_percent_min_max") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                s.size = Size<Dimension> { Dimension::Length(120.0f), Auto<Dimension>() };}),
            mkVec(node0, node1)
        )
        .unwrap();
