...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_x_percentage_fixed_size_positive.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_x_percentage_fixed_size_positive") {
    ...
    REQUIRE(size.width == 35.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node0, 35.0f, size.width
