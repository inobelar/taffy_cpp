...
// ATTENTION: GENERATED FROM: taffy/tests/generated/display_none.rs ! DO NOT EDIT BY HAND !

TEST_CASE("display_none") {
    auto taffy = Taffy::New();
    const auto node0 = taffy.new_leaf(StyleBuilder([&](Style& s) { s.flex_grow = 1.0f;})).unwrap();
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) { s.display = Display::None(); s.flex_grow = 1.0f;}))
        .unwrap();
