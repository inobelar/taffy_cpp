/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/margin_auto_mutiple_children_row.rs !
...
TEST_CASE("margin_auto_mutiple_children_row") {
    ...
    REQUIRE_MESSAGE(location.x == 150.0f, "x of node ", Debug(node2), ". Expected ", 150.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 75.0f, "y of node ", Debug(node2), ". Expected ", 75.0f, ". Actual ", location.y);
}
