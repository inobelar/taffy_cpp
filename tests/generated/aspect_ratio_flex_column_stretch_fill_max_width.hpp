...
// ATTENTION: GENERATED FROM: taffy/tests/generated/aspect_ratio_flex_column_stretch_fill_max_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("aspect_ratio_flex_column_stretch_fill_max_width") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style& s) {
                s.max_size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(20.0f) };
