...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_min_content_flex_single_item_margin_percent.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_min_content_flex_single_item_margin_percent") {
    ...
    REQUIRE(size.height == 38.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 38.0f, size.height
    REQUIRE(location.x == 42.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 42.0f, location.x
    REQUIRE(location.y == 1.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 1.0f, location.y
    ...
    REQUIRE(size.width == 28.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node4, 28.0f, size.width
    REQUIRE(size.height == 32.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node4, 32.0f, size.height
    REQUIRE(location.x == 48.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node4, 48.0f, location.x
    REQUIRE(location.y == 42.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node4, 42.0f, location.y
