...
// ATTENTION: GENERATED FROM: taffy/tests/generated/flex_basis_flex_shrink_row.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("flex_basis_flex_shrink_row") {
    ...
    REQUIRE_MESSAGE(size.width == 33.0f, "width of node ", Debug(node1), ". Expected ", 33.0f, ". Actual ", size.width);
