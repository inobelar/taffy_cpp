...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_margins_percent_center.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_margins_percent_center") {
    ...
    REQUIRE_MESSAGE(location.x == 1.0f, "x of node ", Debug(node0), ". Expected ", 1.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 9.0f, "y of node ", Debug(node0), ". Expected ", 9.0f, ". Actual ", location.y);
