...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_auto_percent_indefinite.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_auto_percent_indefinite") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { minmax<TrackSizingFunction>(Auto<MinTrackSizingFunction>(), percent<MaxTrackSizingFunction>(0.2f)) };}),
            mkVec(node0)
        )
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 8.0f, "width of node ", Debug(node0), ". Expected ", 8.0f, ". Actual ", size.width);
