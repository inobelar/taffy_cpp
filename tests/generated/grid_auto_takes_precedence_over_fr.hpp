...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_auto_takes_precedence_over_fr.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_auto_takes_precedence_over_fr") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { Auto<TrackSizingFunction>(), fr<TrackSizingFunction>(1.0f) };
