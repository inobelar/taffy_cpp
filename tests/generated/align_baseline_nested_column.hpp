...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_baseline_nested_column.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("align_baseline_nested_column") {
    ...
    REQUIRE(location.y == 30.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node101, 30.0f, location.y
}
