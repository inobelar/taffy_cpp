...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_with_padding_and_margin.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_with_padding_and_margin") {
    ...
    REQUIRE(location.x == 178.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 178.0f, location.x
    ...
    REQUIRE(location.x == 14.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 14.0f, location.x
    REQUIRE(location.y == 147.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 147.0f, location.y
