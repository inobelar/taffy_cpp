...
TEST_CASE("grid_absolute_with_padding_and_margin") {
    ...
    REQUIRE_MESSAGE(location.x == 14.0f, "x of node ", Debug(node1), ". Expected ", 14.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 147.0f, "y of node ", Debug(node1), ". Expected ", 147.0f, ". Actual ", location.y);
