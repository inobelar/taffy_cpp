...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_min_content_auto.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_min_content_auto") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { minmax<TrackSizingFunction>(min_content<MinTrackSizingFunction>(), Auto<MaxTrackSizingFunction>()) };}),
            mkVec(node0)
        )
        .unwrap();
