...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_aspect_ratio_fill_child_height.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_aspect_ratio_fill_child_height") {
    ...
    REQUIRE_MESSAGE(size.height == 25.0f, "height of node ", Debug(node0), ". Expected ", 25.0f, ". Actual ", size.height);
