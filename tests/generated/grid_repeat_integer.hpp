...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_repeat_integer.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_repeat_integer") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_rows = GridTrackVec<TrackSizingFunction> { repeat(GridTrackRepetition::Count(3), Vec<NonRepeatedTrackSizingFunction>{ length<NonRepeatedTrackSizingFunction>(40.0f) } ) };
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { repeat(GridTrackRepetition::Count(3), Vec<NonRepeatedTrackSizingFunction>{ length<NonRepeatedTrackSizingFunction>(40.0f) } ) };
