...
// ATTENTION: GENERATED FROM: taffy/tests/generated/absolute_layout_align_items_and_justify_content_center_and_top_position.rs ! DO NOT EDIT BY HAND !

TEST_CASE("absolute_layout_align_items_and_justify_content_center_and_top_position") {
    ...
    REQUIRE(location.x == 25.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 25.0f, location.x
