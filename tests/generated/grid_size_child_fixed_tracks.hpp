...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_size_child_fixed_tracks.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_size_child_fixed_tracks") {
    ...
    const auto node4 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style& s) {
                s.align_self = Some(AlignSelf::Start);
                s.justify_self = Some(JustifySelf::Start);
                s.max_size = Size<Dimension> { Dimension::Length(30.0f), Auto<Dimension>() };}),
            MeasureFunc::Raw([](const Size<Option<float>>& known_dimensions, const Size<AvailableSpace>& available_space) {
                const char16_t* TEXT = u"HH\u200bHH\u200bHH\u200bHH";
                return measure_standard_text(
                    known_dimensions,
