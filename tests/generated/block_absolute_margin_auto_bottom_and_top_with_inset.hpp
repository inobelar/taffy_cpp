...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_margin_auto_bottom_and_top_with_inset.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_margin_auto_bottom_and_top_with_inset") {
    ...
    REQUIRE_MESSAGE(location.y == 70.0f, "y of node ", Debug(node0), ". Expected ", 70.0f, ". Actual ", location.y);
}
