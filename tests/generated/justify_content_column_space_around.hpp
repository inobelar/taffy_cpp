...
// ATTENTION: GENERATED FROM: taffy/tests/generated/justify_content_column_space_around.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("justify_content_column_space_around") {
    ...
    REQUIRE_MESSAGE(location.y == 78.0f, "y of node ", Debug(node2), ". Expected ", 78.0f, ". Actual ", location.y);
}
