...
// ATTENTION: GENERATED FROM: taffy/tests/generated/gap_row_gap_align_items_end.rs ! DO NOT EDIT BY HAND !

TEST_CASE("gap_row_gap_align_items_end") {
    ...
    REQUIRE_MESSAGE(location.y == 200.0f, "y of node ", Debug(node3), ". Expected ", 200.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 200.0f, "y of node ", Debug(node4), ". Expected ", 200.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 200.0f, "y of node ", Debug(node5), ". Expected ", 200.0f, ". Actual ", location.y);
}
