...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_aspect_ratio_fill_min_height.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_aspect_ratio_fill_min_height") {
    ...
    REQUIRE(size.height == 17.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 17.0f, size.height
