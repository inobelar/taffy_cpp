...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_gap.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_gap") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.gap = Size<LengthPercentage> { LengthPercentage::Length(40.0f), LengthPercentage::Length(40.0f) };
    ...
    REQUIRE_MESSAGE(location.x == 160.0f, "x of node ", Debug(node2), ". Expected ", 160.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 160.0f, "x of node ", Debug(node5), ". Expected ", 160.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.y == 160.0f, "y of node ", Debug(node6), ". Expected ", 160.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 160.0f, "x of node ", Debug(node8), ". Expected ", 160.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 160.0f, "y of node ", Debug(node8), ". Expected ", 160.0f, ". Actual ", location.y);
}
