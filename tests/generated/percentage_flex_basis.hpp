...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percentage_flex_basis.rs ! DO NOT EDIT BY HAND !

TEST_CASE("percentage_flex_basis") {
    ...
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.flex_grow = 1.0f;
            s.flex_basis = Dimension::Percent(0.25f);}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 125.0f, "width of node ", Debug(node0), ". Expected ", 125.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 75.0f, "width of node ", Debug(node1), ". Expected ", 75.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 200.0f, "height of node ", Debug(node1), ". Expected ", 200.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 125.0f, "x of node ", Debug(node1), ". Expected ", 125.0f, ". Actual ", location.x);
