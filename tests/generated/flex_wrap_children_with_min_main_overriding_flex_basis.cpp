/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/flex_wrap_children_with_min_main_overriding_flex_basis.rs !
...
TEST_CASE("flex_wrap_children_with_min_main_overriding_flex_basis") {
    ...
    REQUIRE_MESSAGE(size.width == 55.0f, "width of node ", Debug(node1), ". Expected ", 55.0f, ". Actual ", size.width);
