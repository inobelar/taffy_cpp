...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_margin_auto_bottom_with_inset.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_margin_auto_bottom_with_inset") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.position = Position::Absolute();
            s.size = Size<Dimension> { Dimension::Length(50.0f), Dimension::Length(50.0f) };
            s.margin = Rect<LengthPercentageAuto> { zero<LengthPercentageAuto>(), zero<LengthPercentageAuto>(), zero<LengthPercentageAuto>(), LengthPercentageAuto::Auto() };
            s.inset = Rect<LengthPercentageAuto> { Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(10.0f), LengthPercentageAuto::Length(20.0f) };}))
        .unwrap();
