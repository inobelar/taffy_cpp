...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_blocked_by_min_height.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_blocked_by_min_height") {
    ...
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.display = Display::Block();
            s.min_size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(1.0f) };
