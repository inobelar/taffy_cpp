/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/absolute_layout_child_order.rs !
...
TEST_CASE("absolute_layout_child_order") {
    ...
    REQUIRE_MESSAGE(size.width == 55.0f, "width of node ", Debug(node0), ". Expected ", 55.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(location.x == 25.0f, "x of node ", Debug(node1), ". Expected ", 25.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 30.0f, "y of node ", Debug(node1), ". Expected ", 30.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node2).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 55.0f, "width of node ", Debug(node2), ". Expected ", 55.0f, ". Actual ", size.width);
