...
TEST_CASE("block_margin_y_collapse_through_positive_and_negative") {
    ...
    REQUIRE_MESSAGE(size.height == 17.0f, "height of node ", Debug(node), ". Expected ", 17.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.y == 7.0f, "y of node ", Debug(node2), ". Expected ", 7.0f, ". Actual ", location.y);
}
