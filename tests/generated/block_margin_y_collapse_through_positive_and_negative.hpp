...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_positive_and_negative.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_positive_and_negative") {
    ...
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.display = Display::Block();
            s.margin = Rect<LengthPercentageAuto> { zero<LengthPercentageAuto>(), zero<LengthPercentageAuto>(), LengthPercentageAuto::Length(5.0f), LengthPercentageAuto::Length(-4.0f) };}))
        .unwrap();
    ...
    REQUIRE(size.height == 17.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node, 17.0f, size.height
    ...
    REQUIRE(location.y == 7.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node2, 7.0f, location.y
}
