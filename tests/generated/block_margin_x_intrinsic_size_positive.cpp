/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_x_intrinsic_size_positive.rs !
...
TEST_CASE("block_margin_x_intrinsic_size_positive") {
    ...
    REQUIRE_MESSAGE(size.width == 15.0f, "width of node ", Debug(node), ". Expected ", 15.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 15.0f, "width of node ", Debug(node1), ". Expected ", 15.0f, ". Actual ", size.width);
