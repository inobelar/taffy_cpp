...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_auto_single_item_fixed_width_with_definite_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_auto_single_item_fixed_width_with_definite_width") {
    ...
    REQUIRE_MESSAGE(location.x == 170.0f, "x of node ", Debug(node2), ". Expected ", 170.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.width == 130.0f, "width of node ", Debug(node4), ". Expected ", 130.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 30.0f, "width of node ", Debug(node5), ". Expected ", 30.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 40.0f, "height of node ", Debug(node5), ". Expected ", 40.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 170.0f, "x of node ", Debug(node5), ". Expected ", 170.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.width == 130.0f, "width of node ", Debug(node7), ". Expected ", 130.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 30.0f, "width of node ", Debug(node8), ". Expected ", 30.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 40.0f, "height of node ", Debug(node8), ". Expected ", 40.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 170.0f, "x of node ", Debug(node8), ". Expected ", 170.0f, ". Actual ", location.x);
