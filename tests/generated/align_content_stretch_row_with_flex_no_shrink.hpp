...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_content_stretch_row_with_flex_no_shrink.rs ! DO NOT EDIT BY HAND !

TEST_CASE("align_content_stretch_row_with_flex_no_shrink") {
    ...
    REQUIRE_MESSAGE(location.x == 100.0f, "x of node ", Debug(node3), ". Expected ", 100.0f, ". Actual ", location.x);
