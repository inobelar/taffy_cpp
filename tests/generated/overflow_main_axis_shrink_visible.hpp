...
// ATTENTION: GENERATED FROM: taffy/tests/generated/overflow_main_axis_shrink_visible.rs ! DO NOT EDIT BY HAND !

TEST_CASE("overflow_main_axis_shrink_visible") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style& s) { s.flex_shrink = 1.0f;}),
