...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_min_content_flex_single_item_margin_auto.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_min_content_flex_single_item_margin_auto") {
    ...
    REQUIRE_MESSAGE(location.y == 55.0f, "y of node ", Debug(node4), ". Expected ", 55.0f, ". Actual ", location.y);
