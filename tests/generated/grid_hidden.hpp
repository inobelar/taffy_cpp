...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_hidden.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_hidden") {
    auto taffy = Taffy::New();
    const auto node0 = taffy.new_leaf(StyleBuilder([&](Style&) { })).unwrap();
    const auto node1 =
        taffy.new_leaf(StyleBuilder([&](Style& s) { s.display = Display::None();})).unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 0.0f, "width of node ", Debug(node6), ". Expected ", 0.0f, ". Actual ", size.width);
