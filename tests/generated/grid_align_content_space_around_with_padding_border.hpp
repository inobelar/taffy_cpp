...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_content_space_around_with_padding_border.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_content_space_around_with_padding_border") {
    ...
    REQUIRE_MESSAGE(location.x == 48.0f, "x of node ", Debug(node0), ". Expected ", 48.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 17.0f, "y of node ", Debug(node0), ". Expected ", 17.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 88.0f, "x of node ", Debug(node1), ". Expected ", 88.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 17.0f, "y of node ", Debug(node1), ". Expected ", 17.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 128.0f, "x of node ", Debug(node2), ". Expected ", 128.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 17.0f, "y of node ", Debug(node2), ". Expected ", 17.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 48.0f, "x of node ", Debug(node3), ". Expected ", 48.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 68.0f, "y of node ", Debug(node3), ". Expected ", 68.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 88.0f, "x of node ", Debug(node4), ". Expected ", 88.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 68.0f, "y of node ", Debug(node4), ". Expected ", 68.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 128.0f, "x of node ", Debug(node5), ". Expected ", 128.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 68.0f, "y of node ", Debug(node5), ". Expected ", 68.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 48.0f, "x of node ", Debug(node6), ". Expected ", 48.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 119.0f, "y of node ", Debug(node6), ". Expected ", 119.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 88.0f, "x of node ", Debug(node7), ". Expected ", 88.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 119.0f, "y of node ", Debug(node7), ". Expected ", 119.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 128.0f, "x of node ", Debug(node8), ". Expected ", 128.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 119.0f, "y of node ", Debug(node8), ". Expected ", 119.0f, ". Actual ", location.y);
}
