...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_justify_self_sized_all.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_justify_self_sized_all") {
    ...
    REQUIRE_MESSAGE(location.x == 30.0f, "x of node ", Debug(node5), ". Expected ", 30.0f, ". Actual ", location.x);
