...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_justify_content_center_with_padding_border.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_justify_content_center_with_padding_border") {
    ...
    REQUIRE(location.x == 52.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 52.0f, location.x
    ...
    REQUIRE(location.x == 92.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 92.0f, location.x
    ...
    REQUIRE(location.x == 132.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 132.0f, location.x
    ...
    REQUIRE(location.x == 52.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node3, 52.0f, location.x
    ...
    REQUIRE(location.x == 92.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node4, 92.0f, location.x
    ...
    REQUIRE(location.x == 132.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node5, 132.0f, location.x
    ...
    REQUIRE(location.x == 52.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node6, 52.0f, location.x
    ...
    REQUIRE(location.x == 92.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node7, 92.0f, location.x
    ...
    REQUIRE(location.x == 132.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node8, 132.0f, location.x
