...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_child_with_max_height.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("block_absolute_child_with_max_height") {
    ...
    REQUIRE(size.height == 150.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node00, 150.0f, size.height
