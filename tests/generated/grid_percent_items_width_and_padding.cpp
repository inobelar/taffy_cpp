...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_percent_items_width_and_padding.rs !
...
TEST_CASE("grid_percent_items_width_and_padding") {
    ...
    REQUIRE_MESSAGE(size.height == 12.0f, "height of node ", Debug(node), ". Expected ", 12.0f, ". Actual ", size.height);
