...
TEST_CASE("grid_percent_items_nested_with_padding_margin") {
    ...
    REQUIRE(size.height == 41.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 41.0f, size.height
    ...
    REQUIRE(size.height == 149.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 149.0f, size.height
    REQUIRE(location.x == 0.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 0.0f, location.x
    REQUIRE(location.y == 51.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 51.0f, location.y
}
