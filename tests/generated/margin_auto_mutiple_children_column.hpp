...
TEST_CASE("margin_auto_mutiple_children_column") {
    ...
    REQUIRE(location.x == 75.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 75.0f, location.x
    REQUIRE(location.y == 25.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node0, 25.0f, location.y
    ...
    REQUIRE(location.x == 75.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 75.0f, location.x
    REQUIRE(location.y == 150.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node2, 150.0f, location.y
}
