/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/measure_height_overrides_measure.rs !
...
TEST_CASE("measure_height_overrides_measure") {
    ...
    REQUIRE_MESSAGE(size.height == 5.0f, "height of node ", Debug(node), ". Expected ", 5.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 5.0f, "height of node ", Debug(node0), ". Expected ", 5.0f, ". Actual ", size.height);
