...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_first_child_collapse_not_blocked_by_padding_bottom.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_first_child_collapse_not_blocked_by_padding_bottom") {
    ...
    REQUIRE_MESSAGE(size.height == 21.0f, "height of node ", Debug(node), ". Expected ", 21.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 11.0f, "height of node ", Debug(node0), ". Expected ", 11.0f, ". Actual ", size.height);
