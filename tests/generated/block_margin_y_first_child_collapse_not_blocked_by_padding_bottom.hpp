...
TEST_CASE("block_margin_y_first_child_collapse_not_blocked_by_padding_bottom") {
    ...
    REQUIRE(size.height == 21.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node, 21.0f, size.height
    ...
    REQUIRE(size.height == 11.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 11.0f, size.height
