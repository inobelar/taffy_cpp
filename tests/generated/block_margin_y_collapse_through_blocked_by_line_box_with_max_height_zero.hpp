...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_blocked_by_line_box_with_max_height_zero.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_blocked_by_line_box_with_max_height_zero") {
    ...
    const auto node1 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style& s) {
                s.display = Display::Block();
                s.max_size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(0.0f) };
