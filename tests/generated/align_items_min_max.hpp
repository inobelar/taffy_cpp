...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_items_min_max.rs ! DO NOT EDIT BY HAND !
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.max_size = Size<Dimension> { Dimension::Length(200.0f), Auto<Dimension>() };}),
            mkVec(node0)
        )
        .unwrap();
