...
// ATTENTION: GENERATED FROM: taffy/tests/generated/gap_column_gap_wrap_align_space_around.rs ! DO NOT EDIT BY HAND !

TEST_CASE("gap_column_gap_wrap_align_space_around") {
    ...
    REQUIRE_MESSAGE(location.y == 70.0f, "y of node ", Debug(node3), ". Expected ", 70.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 70.0f, "y of node ", Debug(node4), ". Expected ", 70.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 70.0f, "y of node ", Debug(node5), ". Expected ", 70.0f, ". Actual ", location.y);
}
