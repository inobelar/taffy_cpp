...
TEST_CASE("gap_column_gap_wrap_align_space_around") {
    ...
    REQUIRE(location.y == 70.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node4, 70.0f, location.y
    ...
    REQUIRE(location.y == 70.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node5, 70.0f, location.y
}
