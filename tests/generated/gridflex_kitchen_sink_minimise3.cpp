...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/gridflex_kitchen_sink_minimise3.rs !
...
TEST_CASE("gridflex_kitchen_sink_minimise3") {
    ...
    REQUIRE_MESSAGE(size.height == 6.0f, "height of node ", Debug(node01), ". Expected ", 6.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 2.0f, "height of node ", Debug(node02), ". Expected ", 2.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node02), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 6.0f, "y of node ", Debug(node02), ". Expected ", 6.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node03).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 2.0f, "width of node ", Debug(node03), ". Expected ", 2.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 2.0f, "height of node ", Debug(node03), ". Expected ", 2.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 20.0f, "x of node ", Debug(node03), ". Expected ", 20.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 6.0f, "y of node ", Debug(node03), ". Expected ", 6.0f, ". Actual ", location.y);
}
