...
// ATTENTION: GENERATED FROM: taffy/tests/generated/absolute_child_with_max_height_larger_shrinkable_grandchild.rs ! DO NOT EDIT BY HAND !

TEST_CASE("absolute_child_with_max_height_larger_shrinkable_grandchild") {
    auto taffy = Taffy::New();
    const auto node00 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.flex_shrink = 1.0f;
            s.flex_basis = Dimension::Length(150.0f);
