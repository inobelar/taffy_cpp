...
// ATTENTION: GENERATED FROM: taffy/tests/generated/justify_content_row_center.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("justify_content_row_center") {
    ...
    REQUIRE(location.x == 35.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 35.0f, location.x
