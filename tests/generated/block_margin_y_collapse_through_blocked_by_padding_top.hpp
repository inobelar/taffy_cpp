...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_blocked_by_padding_top.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_blocked_by_padding_top") {
    ...
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.padding = Rect<LengthPercentage> { zero<LengthPercentage>(), zero<LengthPercentage>(), LengthPercentage::Length(1.0f), zero<LengthPercentage>() };}))
        .unwrap();
