...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_column_fixed_width_above_range.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_column_fixed_width_above_range") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.size = Size<Dimension> { Dimension::Length(140.0f), Auto<Dimension>() };}),
