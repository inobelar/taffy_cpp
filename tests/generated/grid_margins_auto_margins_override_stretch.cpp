...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_margins_auto_margins_override_stretch.rs !
...
TEST_CASE("grid_margins_auto_margins_override_stretch") {
    ...
    REQUIRE_MESSAGE(location.y == 105.0f, "y of node ", Debug(node6), ". Expected ", 105.0f, ". Actual ", location.y);
