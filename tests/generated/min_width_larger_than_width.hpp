...
// ATTENTION: GENERATED FROM: taffy/tests/generated/min_width_larger_than_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("min_width_larger_than_width") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.size = Size<Dimension> { Dimension::Length(25.0f), Auto<Dimension>() };
