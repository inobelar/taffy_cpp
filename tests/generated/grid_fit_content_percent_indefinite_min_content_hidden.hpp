...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_fit_content_percent_indefinite_min_content_hidden.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_fit_content_percent_indefinite_min_content_hidden") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { fit_content<TrackSizingFunction>(percent<LengthPercentage>(0.5f)) };}),
            mkVec(node0)
        )
        .unwrap();
