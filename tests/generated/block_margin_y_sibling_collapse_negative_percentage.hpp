...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_sibling_collapse_negative_percentage.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_sibling_collapse_negative_percentage") {
    ...
    REQUIRE_MESSAGE(size.height == 15.0f, "height of node ", Debug(node), ". Expected ", 15.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.y == 5.0f, "y of node ", Debug(node2), ". Expected ", 5.0f, ". Actual ", location.y);
