...
// ATTENTION: GENERATED FROM: taffy/tests/generated/border_center_child.rs ! DO NOT EDIT BY HAND !
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.border = Rect<LengthPercentage> { zero<LengthPercentage>(), zero<LengthPercentage>(), LengthPercentage::Length(10.0f), LengthPercentage::Length(20.0f) };}),
            mkVec(node0)
        )
        .unwrap();
