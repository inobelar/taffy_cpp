...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_column_with_auto_fixed.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_column_with_auto_fixed") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { minmax<TrackSizingFunction>(length<MinTrackSizingFunction>(20.0f), length<MaxTrackSizingFunction>(40.0f)), Auto<TrackSizingFunction>() };
