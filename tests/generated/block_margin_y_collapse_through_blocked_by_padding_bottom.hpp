...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_blocked_by_padding_bottom.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_blocked_by_padding_bottom") {
    ...
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.padding = Rect<LengthPercentage> { zero<LengthPercentage>(), zero<LengthPercentage>(), zero<LengthPercentage>(), LengthPercentage::Length(1.0f) };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.height == 41.0f, "height of node ", Debug(node), ". Expected ", 41.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 1.0f, "height of node ", Debug(node1), ". Expected ", 1.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.y == 31.0f, "y of node ", Debug(node2), ". Expected ", 31.0f, ". Actual ", location.y);
}
