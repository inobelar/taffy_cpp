...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_max_content_single_item_margin_fixed.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_max_content_single_item_margin_fixed") {
    ...
    REQUIRE(location.x == 110.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 110.0f, location.x
    ...
    REQUIRE(size.width == 70.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node4, 70.0f, size.width
    ...
    REQUIRE(location.x == 110.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node5, 110.0f, location.x
    ...
    REQUIRE(size.width == 70.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node7, 70.0f, size.width
    ...
    REQUIRE(location.x == 110.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node8, 110.0f, location.x
