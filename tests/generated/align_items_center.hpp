...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_items_center.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("align_items_center") {
    ...
    REQUIRE_MESSAGE(location.y == 45.0f, "y of node ", Debug(node0), ". Expected ", 45.0f, ". Actual ", location.y);
}
