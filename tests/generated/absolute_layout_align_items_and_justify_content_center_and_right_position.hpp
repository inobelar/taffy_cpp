...
// ATTENTION: GENERATED FROM: taffy/tests/generated/absolute_layout_align_items_and_justify_content_center_and_right_position.rs ! DO NOT EDIT BY HAND !

TEST_CASE("absolute_layout_align_items_and_justify_content_center_and_right_position") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.position = Position::Absolute();
            s.size = Size<Dimension> { Dimension::Length(60.0f), Dimension::Length(40.0f) };
            s.inset = Rect<LengthPercentageAuto> { Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(5.0f), Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>() };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.x == 45.0f, "x of node ", Debug(node0), ". Expected ", 45.0f, ". Actual ", location.x);
