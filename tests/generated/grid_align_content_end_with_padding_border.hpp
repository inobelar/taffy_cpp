...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_content_end_with_padding_border.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_content_end_with_padding_border") {
    ...
    REQUIRE_MESSAGE(location.y == 44.0f, "y of node ", Debug(node0), ". Expected ", 44.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 44.0f, "y of node ", Debug(node1), ". Expected ", 44.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 44.0f, "y of node ", Debug(node2), ". Expected ", 44.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 84.0f, "y of node ", Debug(node3), ". Expected ", 84.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 84.0f, "y of node ", Debug(node4), ". Expected ", 84.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 84.0f, "y of node ", Debug(node5), ". Expected ", 84.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 124.0f, "y of node ", Debug(node6), ". Expected ", 124.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 124.0f, "y of node ", Debug(node7), ". Expected ", 124.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 124.0f, "y of node ", Debug(node8), ". Expected ", 124.0f, ". Actual ", location.y);
}
