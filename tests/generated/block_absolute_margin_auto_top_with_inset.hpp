...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_margin_auto_top_with_inset.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_margin_auto_top_with_inset") {
    ...
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.inset = Rect<LengthPercentageAuto> { Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(20.0f), LengthPercentageAuto::Length(10.0f) };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.y == 140.0f, "y of node ", Debug(node0), ". Expected ", 140.0f, ". Actual ", location.y);
}
