...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_justify_items_sized_center.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_justify_items_sized_center") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.justify_items = Some(JustifyItems::Center);
