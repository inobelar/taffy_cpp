...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_auto_single_item.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_auto_single_item") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { length<TrackSizingFunction>(40.0f), Auto<TrackSizingFunction>(), length<TrackSizingFunction>(40.0f) };}),
