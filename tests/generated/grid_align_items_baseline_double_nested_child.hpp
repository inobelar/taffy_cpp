...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_items_baseline_double_nested_child.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_items_baseline_double_nested_child") {
    ...
    REQUIRE_MESSAGE(size.height == 15.0f, "height of node ", Debug(node10), ". Expected ", 15.0f, ". Actual ", size.height);
