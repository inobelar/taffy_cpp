...
TEST_CASE("grid_justify_content_end_with_padding_border") {
    ...
    REQUIRE_MESSAGE(location.x == 56.0f, "x of node ", Debug(node0), ". Expected ", 56.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 96.0f, "x of node ", Debug(node1), ". Expected ", 96.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 136.0f, "x of node ", Debug(node2), ". Expected ", 136.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 56.0f, "x of node ", Debug(node3), ". Expected ", 56.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 96.0f, "x of node ", Debug(node4), ". Expected ", 96.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 136.0f, "x of node ", Debug(node5), ". Expected ", 136.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 56.0f, "x of node ", Debug(node6), ". Expected ", 56.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 96.0f, "x of node ", Debug(node7), ". Expected ", 96.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 136.0f, "x of node ", Debug(node8), ". Expected ", 136.0f, ". Actual ", location.x);
