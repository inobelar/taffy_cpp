...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_justify_content_end_with_padding_border.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_justify_content_end_with_padding_border") {
    ...
    REQUIRE(location.x == 56.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 56.0f, location.x
    ...
    REQUIRE(location.x == 96.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 96.0f, location.x
    ...
    REQUIRE(location.x == 136.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 136.0f, location.x
    ...
    REQUIRE(location.x == 56.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node3, 56.0f, location.x
    REQUIRE(location.y == 52.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node3, 52.0f, location.y
    ...
    REQUIRE(location.x == 96.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node4, 96.0f, location.x
    REQUIRE(location.y == 52.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node4, 52.0f, location.y
    ...
    REQUIRE(location.x == 136.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node5, 136.0f, location.x
    REQUIRE(location.y == 52.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node5, 52.0f, location.y
    ...
    REQUIRE(location.x == 56.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node6, 56.0f, location.x
    REQUIRE(location.y == 92.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node6, 92.0f, location.y
    ...
    REQUIRE(location.x == 96.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node7, 96.0f, location.x
    REQUIRE(location.y == 92.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node7, 92.0f, location.y
    ...
    REQUIRE(location.x == 136.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node8, 136.0f, location.x
    REQUIRE(location.y == 92.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node8, 92.0f, location.y
}
