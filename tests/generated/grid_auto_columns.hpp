...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_auto_columns.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_auto_columns") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_rows = GridTrackVec<TrackSizingFunction> { length<TrackSizingFunction>(100.0f) };
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { length<TrackSizingFunction>(40.0f) };
                s.grid_auto_columns = GridTrackVec<NonRepeatedTrackSizingFunction> { length<NonRepeatedTrackSizingFunction>(10.0f), length<NonRepeatedTrackSizingFunction>(20.0f), length<NonRepeatedTrackSizingFunction>(30.0f) };
    ...
    REQUIRE_MESSAGE(size.width == 190.0f, "width of node ", Debug(node), ". Expected ", 190.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(location.x == 70.0f, "x of node ", Debug(node2), ". Expected ", 70.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node3), ". Expected ", 100.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node4), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 100.0f, "x of node ", Debug(node4), ". Expected ", 100.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node5), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 130.0f, "x of node ", Debug(node5), ". Expected ", 130.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node6), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 140.0f, "x of node ", Debug(node6), ". Expected ", 140.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node7), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 160.0f, "x of node ", Debug(node7), ". Expected ", 160.0f, ". Actual ", location.x);
