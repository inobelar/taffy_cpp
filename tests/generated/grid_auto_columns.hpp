...
TEST_CASE("grid_auto_columns") {
    ...
    REQUIRE(size.width == 190.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node, 190.0f, size.width
    ...
    REQUIRE(size.height == 100.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node5, 100.0f, size.height
    REQUIRE(location.x == 130.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node5, 130.0f, location.x
    ...
    REQUIRE(size.height == 100.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node6, 100.0f, size.height
    REQUIRE(location.x == 140.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node6, 140.0f, location.x
    ...
    REQUIRE(size.height == 100.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node7, 100.0f, size.height
    REQUIRE(location.x == 160.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node7, 160.0f, location.x
