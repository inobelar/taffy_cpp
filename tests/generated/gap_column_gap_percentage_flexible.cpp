/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/gap_column_gap_percentage_flexible.rs !
...
TEST_CASE("gap_column_gap_percentage_flexible") {
    ...
    REQUIRE_MESSAGE(size.width == 27.0f, "width of node ", Debug(node0), ". Expected ", 27.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 26.0f, "width of node ", Debug(node1), ". Expected ", 26.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node1), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 37.0f, "x of node ", Debug(node1), ". Expected ", 37.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 0.0f, "y of node ", Debug(node1), ". Expected ", 0.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node2).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 27.0f, "width of node ", Debug(node2), ". Expected ", 27.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node2), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 73.0f, "x of node ", Debug(node2), ". Expected ", 73.0f, ". Actual ", location.x);
