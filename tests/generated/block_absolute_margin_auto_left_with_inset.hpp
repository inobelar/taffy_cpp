...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_margin_auto_left_with_inset.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_margin_auto_left_with_inset") {
    ...
    REQUIRE_MESSAGE(location.x == 130.0f, "x of node ", Debug(node0), ". Expected ", 130.0f, ". Actual ", location.x);
