...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_content_space_evenly_wrapped.rs ! DO NOT EDIT BY HAND !

TEST_CASE("align_content_space_evenly_wrapped") {
    ...
    REQUIRE_MESSAGE(location.y == 18.0f, "y of node ", Debug(node0), ". Expected ", 18.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 18.0f, "y of node ", Debug(node1), ". Expected ", 18.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 45.0f, "y of node ", Debug(node2), ". Expected ", 45.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 45.0f, "y of node ", Debug(node3), ". Expected ", 45.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 73.0f, "y of node ", Debug(node4), ". Expected ", 73.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 73.0f, "y of node ", Debug(node5), ". Expected ", 73.0f, ". Actual ", location.y);
}
