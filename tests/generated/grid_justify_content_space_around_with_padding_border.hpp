...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_justify_content_space_around_with_padding_border.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_justify_content_space_around_with_padding_border") {
    ...
    REQUIRE(location.x == 49.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 49.0f, location.x
    ...
    REQUIRE(location.x == 49.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node3, 49.0f, location.x
    ...
    REQUIRE(location.x == 135.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node5, 135.0f, location.x
    ...
    REQUIRE(location.x == 49.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node6, 49.0f, location.x
    ...
    REQUIRE(location.x == 135.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node8, 135.0f, location.x
