...
TEST_CASE("grid_justify_content_space_around_with_padding_border") {
    ...
    REQUIRE_MESSAGE(location.x == 49.0f, "x of node ", Debug(node0), ". Expected ", 49.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 135.0f, "x of node ", Debug(node2), ". Expected ", 135.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 49.0f, "x of node ", Debug(node3), ". Expected ", 49.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 135.0f, "x of node ", Debug(node5), ". Expected ", 135.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 49.0f, "x of node ", Debug(node6), ". Expected ", 49.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 135.0f, "x of node ", Debug(node8), ". Expected ", 135.0f, ". Actual ", location.x);
