...
// ATTENTION: GENERATED FROM: taffy/tests/generated/blockflex_overflow_hidden.rs ! DO NOT EDIT BY HAND !

TEST_CASE("blockflex_overflow_hidden") {
    ...
    const auto node1 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style& s) { s.display = Display::Block(); s.flex_grow = 1.0f;}),
            MeasureFunc::Raw([](const Size<Option<float>>& known_dimensions, const Size<AvailableSpace>& available_space) {
                const char16_t* TEXT = u"HHHH\u200bHH";
                return measure_standard_text(
                    known_dimensions,
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.size = Size<Dimension> { Dimension::Length(20.0f), Dimension::Length(50.0f) };}),
            mkVec(node0, node1)
        )
        .unwrap();
