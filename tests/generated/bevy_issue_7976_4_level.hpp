...
TEST_CASE("bevy_issue_7976_4_level") {
    ...
    REQUIRE(size.height == 170.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node000, 170.0f, size.height
    REQUIRE(location.x == 5.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node000, 5.0f, location.x
    REQUIRE(location.y == 5.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node000, 5.0f, location.y
}
