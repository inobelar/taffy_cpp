...
TEST_CASE("rounding_inner_node_controversy_vertical") {
    ...
    REQUIRE(size.height == 106.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 106.0f, size.height
    REQUIRE(location.x == 0.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 0.0f, location.x
    REQUIRE(location.y == 107.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 107.0f, location.y
    { const Layout& l = taffy.layout(node10).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE(size.width == 10.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node10, 10.0f, size.width
    REQUIRE(size.height == 106.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node10, 106.0f, size.height
    ...
    REQUIRE(size.height == 107.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node2, 107.0f, size.height
    REQUIRE(location.x == 0.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 0.0f, location.x
    REQUIRE(location.y == 213.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node2, 213.0f, location.y
}
