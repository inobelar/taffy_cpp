...
// ATTENTION: GENERATED FROM: taffy/tests/generated/rounding_inner_node_controversy_vertical.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("rounding_inner_node_controversy_vertical") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                s.flex_direction = FlexDirection::Column();
                s.size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(320.0f) };}),
    ...
    REQUIRE_MESSAGE(size.height == 106.0f, "height of node ", Debug(node1), ". Expected ", 106.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node1), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 107.0f, "y of node ", Debug(node1), ". Expected ", 107.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node10).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 10.0f, "width of node ", Debug(node10), ". Expected ", 10.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 106.0f, "height of node ", Debug(node10), ". Expected ", 106.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 107.0f, "height of node ", Debug(node2), ". Expected ", 107.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node2), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 213.0f, "y of node ", Debug(node2), ". Expected ", 213.0f, ". Actual ", location.y);
}
