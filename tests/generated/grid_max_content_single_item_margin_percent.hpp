...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_max_content_single_item_margin_percent.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_max_content_single_item_margin_percent") {
    ...
    REQUIRE_MESSAGE(size.width == 28.0f, "width of node ", Debug(node1), ". Expected ", 28.0f, ". Actual ", size.width);
