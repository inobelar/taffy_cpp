...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_content_end.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_content_end") {
    ...
    REQUIRE_MESSAGE(location.y == 120.0f, "y of node ", Debug(node3), ". Expected ", 120.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 120.0f, "y of node ", Debug(node4), ". Expected ", 120.0f, ". Actual ", location.y);
