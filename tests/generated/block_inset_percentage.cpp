/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/block_inset_percentage.rs !
...
TEST_CASE("block_inset_percentage") {
    ...
    REQUIRE_MESSAGE(location.x == -3.0f, "x of node ", Debug(node1), ". Expected ", -3.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 1.0f, "x of node ", Debug(node2), ". Expected ", 1.0f, ". Actual ", location.x);
