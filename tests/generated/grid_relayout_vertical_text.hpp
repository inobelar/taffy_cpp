...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_relayout_vertical_text.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_relayout_vertical_text") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style&) { }),
            MeasureFunc::Raw([](const Size<Option<float>>& known_dimensions, const Size<AvailableSpace>& available_space) {
                const char16_t* TEXT = u"HH\u200bHH\u200bHH\u200bHH\u200bHH\u200bHH\u200bHH";
