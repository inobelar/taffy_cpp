...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percentage_flex_basis_main_max_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("percentage_flex_basis_main_max_width") {
    ...
    REQUIRE(size.width == 120.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node0, 120.0f, size.width
    REQUIRE(size.height == 400.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 400.0f, size.height
    ...
    REQUIRE(size.height == 400.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 400.0f, size.height
