...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_blocked_by_overflow_x_scroll.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_blocked_by_overflow_x_scroll") {
    ...
    REQUIRE_MESSAGE(size.height == 55.0f, "height of node ", Debug(node), ". Expected ", 55.0f, ". Actual ", size.height);
