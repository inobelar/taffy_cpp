...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_percent_items_nested_with_margin.rs !
...
TEST_CASE("grid_percent_items_nested_with_margin") {
    ...
    REQUIRE_MESSAGE(size.width == 45.0f, "width of node ", Debug(node00), ". Expected ", 45.0f, ". Actual ", size.width);
