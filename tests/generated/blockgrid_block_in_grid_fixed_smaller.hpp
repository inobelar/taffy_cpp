...
// ATTENTION: GENERATED FROM: taffy/tests/generated/blockgrid_block_in_grid_fixed_smaller.rs ! DO NOT EDIT BY HAND !

TEST_CASE("blockgrid_block_in_grid_fixed_smaller") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { length<TrackSizingFunction>(10.0f) };}),
            mkVec(node0, node1)
        )
        .unwrap();
