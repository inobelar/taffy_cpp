...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_with_absolute_child.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_with_absolute_child") {
