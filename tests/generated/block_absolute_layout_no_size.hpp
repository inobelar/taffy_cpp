...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_layout_no_size.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_layout_no_size") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) { s.position = Position::Absolute();}))
        .unwrap();
