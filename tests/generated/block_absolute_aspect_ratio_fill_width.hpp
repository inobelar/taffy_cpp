...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_aspect_ratio_fill_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_aspect_ratio_fill_width") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.position = Position::Absolute();
            s.size = Size<Dimension> { Auto<Dimension>(), Dimension::Percent(0.2f) };
