...
TEST_CASE("grid_absolute_container_left_right_margin") {
    ...
    REQUIRE(size.width == 167.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node0, 167.0f, size.width
    REQUIRE(size.height == 0.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 0.0f, size.height
    REQUIRE(location.x == 9.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 9.0f, location.x
    ...
    REQUIRE(location.x == 120.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node3, 120.0f, location.x
    ...
    REQUIRE(location.x == 120.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node6, 120.0f, location.x
