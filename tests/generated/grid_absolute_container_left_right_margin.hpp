...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_left_right_margin.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_left_right_margin") {
    ...
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.inset = Rect<LengthPercentageAuto> { LengthPercentageAuto::Length(5.0f), LengthPercentageAuto::Length(2.0f), Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>() };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.width == 167.0f, "width of node ", Debug(node0), ". Expected ", 167.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 0.0f, "height of node ", Debug(node0), ". Expected ", 0.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 9.0f, "x of node ", Debug(node0), ". Expected ", 9.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 120.0f, "x of node ", Debug(node3), ". Expected ", 120.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 120.0f, "x of node ", Debug(node6), ". Expected ", 120.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.y == 90.0f, "y of node ", Debug(node7), ". Expected ", 90.0f, ". Actual ", location.y);
