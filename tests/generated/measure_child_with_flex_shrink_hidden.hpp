...
TEST_CASE("measure_child_with_flex_shrink_hidden") {
    ...
    REQUIRE(size.width == 91.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node1, 91.0f, size.width
    REQUIRE(size.height == 50.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 50.0f, size.height
    REQUIRE(location.x == 9.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 9.0f, location.x
