...
// ATTENTION: GENERATED FROM: taffy/tests/generated/measure_child_with_flex_shrink_hidden.rs ! DO NOT EDIT BY HAND !

TEST_CASE("measure_child_with_flex_shrink_hidden") {
    ...
    const auto node1 = taffy
        .new_leaf_with_measure(
            ...
            MeasureFunc::Raw([](const Size<Option<float>>& known_dimensions, const Size<AvailableSpace>& available_space) {
                const char16_t* TEXT = u"HHHHHHHHHH\u200bHHHHHHHHHH\u200bHHHHHHHHHH\u200bHHHHHHHHHH\u200bHHHHHHHHHH";
    ...
    REQUIRE_MESSAGE(size.width == 91.0f, "width of node ", Debug(node1), ". Expected ", 91.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 50.0f, "height of node ", Debug(node1), ". Expected ", 50.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 9.0f, "x of node ", Debug(node1), ". Expected ", 9.0f, ". Actual ", location.x);
