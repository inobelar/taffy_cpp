...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_with_padding.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("grid_absolute_with_padding") {
    ...
    REQUIRE(location.x == 180.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 180.0f, location.x
    ...
    REQUIRE(location.y == 150.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 150.0f, location.y
