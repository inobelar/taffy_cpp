...
TEST_CASE("margin_with_sibling_row") {
    ...
    REQUIRE(size.width == 45.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node0, 45.0f, size.width
    ...
    REQUIRE(size.width == 45.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node1, 45.0f, size.width
    REQUIRE(size.height == 100.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 100.0f, size.height
    REQUIRE(location.x == 55.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 55.0f, location.x
