...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_first_child_collapse_blocked_by_padding_top.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_first_child_collapse_blocked_by_padding_top") {
    ...
    REQUIRE_MESSAGE(size.height == 21.0f, "height of node ", Debug(node0), ". Expected ", 21.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.y == 11.0f, "y of node ", Debug(node00), ". Expected ", 11.0f, ". Actual ", location.y);
