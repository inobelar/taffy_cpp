...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_justify_content_space_evenly.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_justify_content_space_evenly") {
    ...
    REQUIRE_MESSAGE(location.x == 20.0f, "x of node ", Debug(node6), ". Expected ", 20.0f, ". Actual ", location.x);
