...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percentage_padding_should_calculate_based_only_on_width.rs ! DO NOT EDIT BY HAND !

TEST_CASE("percentage_padding_should_calculate_based_only_on_width") {
    ...
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.flex_grow = 1.0f;
                s.padding = Rect<LengthPercentage> { LengthPercentage::Percent(0.1f), LengthPercentage::Percent(0.1f), LengthPercentage::Percent(0.1f), LengthPercentage::Percent(0.1f) };}),
            mkVec(node00)
        )
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.x == 20.0f, "x of node ", Debug(node00), ". Expected ", 20.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 20.0f, "y of node ", Debug(node00), ". Expected ", 20.0f, ". Actual ", location.y);
}
