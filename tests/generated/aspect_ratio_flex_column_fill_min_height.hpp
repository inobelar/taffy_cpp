...
// ATTENTION: GENERATED FROM: taffy/tests/generated/aspect_ratio_flex_column_fill_min_height.rs ! DO NOT EDIT BY HAND !

TEST_CASE("aspect_ratio_flex_column_fill_min_height") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.min_size = Size<Dimension> { Dimension::Length(40.0f), Auto<Dimension>() };
