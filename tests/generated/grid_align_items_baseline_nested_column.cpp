...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_items_baseline_nested_column.rs !
...
TEST_CASE("grid_align_items_baseline_nested_column") {
    ...
    REQUIRE_MESSAGE(location.y == 35.0f, "y of node ", Debug(node101), ". Expected ", 35.0f, ". Actual ", location.y);
}
