...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_max_content_single_item_span_2_gap_percent_indefinite.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_max_content_single_item_span_2_gap_percent_indefinite") {
    ...
    REQUIRE_MESSAGE(location.x == 60.0f, "x of node ", Debug(node3), ". Expected ", 60.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 60.0f, "x of node ", Debug(node6), ". Expected ", 60.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 100.0f, "x of node ", Debug(node7), ". Expected ", 100.0f, ". Actual ", location.x);
