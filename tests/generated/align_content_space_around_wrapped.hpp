...
TEST_CASE("align_content_space_around_wrapped") {
    ...
    REQUIRE_MESSAGE(location.y == 78.0f, "y of node ", Debug(node4), ". Expected ", 78.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 78.0f, "y of node ", Debug(node5), ". Expected ", 78.0f, ". Actual ", location.y);
}
