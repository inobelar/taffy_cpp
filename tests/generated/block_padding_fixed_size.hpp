...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_padding_fixed_size.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_padding_fixed_size") {
    ...
    REQUIRE_MESSAGE(size.width == 38.0f, "width of node ", Debug(node0), ". Expected ", 38.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 38.0f, "width of node ", Debug(node1), ". Expected ", 38.0f, ". Actual ", size.width);
