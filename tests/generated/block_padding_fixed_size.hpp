...
TEST_CASE("block_padding_fixed_size") {
    ...
    REQUIRE(size.width == 38.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node0, 38.0f, size.width
    ...
    REQUIRE(size.width == 38.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node1, 38.0f, size.width
