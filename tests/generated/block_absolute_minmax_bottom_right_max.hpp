...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_minmax_bottom_right_max.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_minmax_bottom_right_max") {
    ...
    REQUIRE(location.y == 60.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node0, 60.0f, location.y
}
