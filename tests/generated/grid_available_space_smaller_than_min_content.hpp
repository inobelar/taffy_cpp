...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_available_space_smaller_than_min_content.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_available_space_smaller_than_min_content") {
    ...
    const auto node = taffy
        ...
        .unwrap();
    taffy
        .compute_layout(node, Size<AvailableSpace>{ AvailableSpace::Definite(60.0f), AvailableSpace::MaxContent() })
        .unwrap();
    puts("\nComputed tree:");
