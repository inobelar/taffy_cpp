...
// ATTENTION: GENERATED FROM: taffy/tests/generated/relative_position_should_not_nudge_siblings.rs ! DO NOT EDIT BY HAND !

TEST_CASE("relative_position_should_not_nudge_siblings") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.size = Size<Dimension> { Auto<Dimension>(), Dimension::Length(10.0f) };
            s.inset = Rect<LengthPercentageAuto> { Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(15.0f), Auto<LengthPercentageAuto>() };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.y == 25.0f, "y of node ", Debug(node1), ". Expected ", 25.0f, ". Actual ", location.y);
}
