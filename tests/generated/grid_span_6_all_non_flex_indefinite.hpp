...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_span_6_all_non_flex_indefinite.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_span_6_all_non_flex_indefinite") {
    ...
    REQUIRE_MESSAGE(size.width == 89.0f, "width of node ", Debug(node2), ". Expected ", 89.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(location.x == 99.0f, "x of node ", Debug(node3), ". Expected ", 99.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 40.0f, "y of node ", Debug(node3), ". Expected ", 40.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node4).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 9.0f, "width of node ", Debug(node4), ". Expected ", 9.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 40.0f, "height of node ", Debug(node4), ". Expected ", 40.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 109.0f, "x of node ", Debug(node4), ". Expected ", 109.0f, ". Actual ", location.x);
