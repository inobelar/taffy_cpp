...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percentage_flex_basis_cross_min_height.rs ! DO NOT EDIT BY HAND !

TEST_CASE("percentage_flex_basis_cross_min_height") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.flex_grow = 1.0f;
            s.min_size = Size<Dimension> { Auto<Dimension>(), Dimension::Percent(0.6f) };}))
        .unwrap();
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.flex_grow = 2.0f;
            s.min_size = Size<Dimension> { Auto<Dimension>(), Dimension::Percent(0.1f) };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.height == 160.0f, "height of node ", Debug(node1), ". Expected ", 160.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node1), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 240.0f, "y of node ", Debug(node1), ". Expected ", 240.0f, ". Actual ", location.y);
}
