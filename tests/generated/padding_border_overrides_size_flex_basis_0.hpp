...
// ATTENTION: GENERATED FROM: taffy/tests/generated/padding_border_overrides_size_flex_basis_0.rs ! DO NOT EDIT BY HAND !

TEST_CASE("padding_border_overrides_size_flex_basis_0") {
    ...
    REQUIRE_MESSAGE(location.x == 22.0f, "x of node ", Debug(node1), ". Expected ", 22.0f, ". Actual ", location.x);
