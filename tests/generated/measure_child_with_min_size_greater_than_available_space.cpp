/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/measure_child_with_min_size_greater_than_available_space.rs !
...
TEST_CASE("measure_child_with_min_size_greater_than_available_space") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf_with_measure(
            StyleBuilder([&](Style& s) {
                s.min_size = Size<Dimension> { Dimension::Length(200.0f), Auto<Dimension>() };}),
