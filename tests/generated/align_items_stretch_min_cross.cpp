/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/align_items_stretch_min_cross.rs !
...
TEST_CASE("align_items_stretch_min_cross") {
    ...
    REQUIRE_MESSAGE(size.width == 400.0f, "width of node ", Debug(node0), ". Expected ", 400.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 36.0f, "height of node ", Debug(node0), ". Expected ", 36.0f, ". Actual ", size.height);
