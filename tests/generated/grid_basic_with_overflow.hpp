...
TEST_CASE("grid_basic_with_overflow") {
    ...
    REQUIRE_MESSAGE(size.width == 40.0f, "width of node ", Debug(node9), ". Expected ", 40.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 0.0f, "height of node ", Debug(node9), ". Expected ", 0.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node9), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 120.0f, "y of node ", Debug(node9), ". Expected ", 120.0f, ". Actual ", location.y);
}
