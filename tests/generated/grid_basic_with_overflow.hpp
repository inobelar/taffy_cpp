...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_basic_with_overflow.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_basic_with_overflow") {
    ...
    const auto node = taffy
        .new_with_children(
            ...
            mkVec(node0, node1, node2, node3, node4, node5, node6, node7, node8, node9)
        )
        .unwrap();
    ...
    REQUIRE(size.width == 40.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node9, 40.0f, size.width
    REQUIRE(size.height == 0.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node9, 0.0f, size.height
    REQUIRE(location.x == 0.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node9, 0.0f, location.x
    REQUIRE(location.y == 120.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node9, 120.0f, location.y
}
