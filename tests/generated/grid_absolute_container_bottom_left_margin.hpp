...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_bottom_left_margin.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_bottom_left_margin") {
    ...
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.inset = Rect<LengthPercentageAuto> { LengthPercentageAuto::Length(0.0f), Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(0.0f) };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.y == 147.0f, "y of node ", Debug(node0), ". Expected ", 147.0f, ". Actual ", location.y);
