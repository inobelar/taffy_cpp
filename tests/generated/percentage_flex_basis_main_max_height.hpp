...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percentage_flex_basis_main_max_height.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("percentage_flex_basis_main_max_height") {
    ...
    REQUIRE(size.width == 148.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node1, 148.0f, size.width
    REQUIRE(size.height == 80.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 80.0f, size.height
    REQUIRE(location.x == 52.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 52.0f, location.x
