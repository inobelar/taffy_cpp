...
// ATTENTION: GENERATED FROM: taffy/tests/generated/wrap_nodes_with_content_sizing_margin_cross.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("wrap_nodes_with_content_sizing_margin_cross") {
    ...
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.size = Size<Dimension> { Dimension::Length(70.0f), Auto<Dimension>() };}),
            mkVec(node00, node01)
        )
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.y == 50.0f, "y of node ", Debug(node01), ". Expected ", 50.0f, ". Actual ", location.y);
