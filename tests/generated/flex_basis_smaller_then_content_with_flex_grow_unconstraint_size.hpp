...
// ATTENTION: GENERATED FROM: taffy/tests/generated/flex_basis_smaller_then_content_with_flex_grow_unconstraint_size.rs ! DO NOT EDIT BY HAND !

TEST_CASE("flex_basis_smaller_then_content_with_flex_grow_unconstraint_size") {
    ...
    REQUIRE(size.width == 90.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node, 90.0f, size.width
    ...
    REQUIRE(location.x == 70.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 70.0f, location.x
