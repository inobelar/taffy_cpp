...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_auto_single_item_fixed_width.rs !
...
TEST_CASE("grid_auto_single_item_fixed_width") {
    ...
    REQUIRE_MESSAGE(size.width == 130.0f, "width of node ", Debug(node1), ". Expected ", 130.0f, ". Actual ", size.width);
