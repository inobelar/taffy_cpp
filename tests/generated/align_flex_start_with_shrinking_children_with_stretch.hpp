...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_flex_start_with_shrinking_children_with_stretch.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("align_flex_start_with_shrinking_children_with_stretch") {
    ...
    REQUIRE(size.height == 0.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node000, 0.0f, size.height
