...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_negative.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_negative") {
    ...
    REQUIRE_MESSAGE(size.height == 13.0f, "height of node ", Debug(node), ". Expected ", 13.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.y == 3.0f, "y of node ", Debug(node1), ". Expected ", 3.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.y == 3.0f, "y of node ", Debug(node2), ". Expected ", 3.0f, ". Actual ", location.y);
}
