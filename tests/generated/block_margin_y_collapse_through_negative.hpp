...
TEST_CASE("block_margin_y_collapse_through_negative") {
    ...
    REQUIRE(size.height == 13.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node, 13.0f, size.height
    ...
    REQUIRE(location.y == 3.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 3.0f, location.y
    ...
    REQUIRE(location.y == 3.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node2, 3.0f, location.y
}
