...
// ATTENTION: GENERATED FROM: taffy/tests/generated/absolute_layout_in_wrap_reverse_column_container_flex_end.rs ! DO NOT EDIT BY HAND !

TEST_CASE("absolute_layout_in_wrap_reverse_column_container_flex_end") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.position = Position::Absolute();
            s.align_self = Some(AlignSelf::FlexEnd);
