...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_fr_fixed_size_no_content_proportions.rs !
...
TEST_CASE("grid_fr_fixed_size_no_content_proportions") {
    ...
    REQUIRE_MESSAGE(size.width == 67.0f, "width of node ", Debug(node1), ". Expected ", 67.0f, ". Actual ", size.width);
