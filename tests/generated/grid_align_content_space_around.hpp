...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_content_space_around.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_content_space_around") {
    ...
    REQUIRE(location.y == 13.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node2, 13.0f, location.y
    ...
    REQUIRE(location.y == 147.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node6, 147.0f, location.y
    ...
    REQUIRE(location.y == 147.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node7, 147.0f, location.y
    ...
    REQUIRE(location.y == 147.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node8, 147.0f, location.y
}
