...
// ATTENTION: GENERATED FROM: taffy/tests/generated/blockgrid_grid_in_block.rs ! DO NOT EDIT BY HAND !

TEST_CASE("blockgrid_grid_in_block") {
    ...
    REQUIRE_MESSAGE(size.height == 70.0f, "height of node ", Debug(node), ". Expected ", 70.0f, ". Actual ", size.height);
