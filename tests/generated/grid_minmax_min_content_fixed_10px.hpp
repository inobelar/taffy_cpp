...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_min_content_fixed_10px.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_min_content_fixed_10px") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { minmax<TrackSizingFunction>(min_content<MinTrackSizingFunction>(), length<MaxTrackSizingFunction>(10.0f)) };}),
            mkVec(node0)
        )
        .unwrap();
