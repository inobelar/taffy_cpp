...
// ATTENTION: GENERATED FROM: taffy/tests/generated/wrap_reverse_column.rs ! DO NOT EDIT BY HAND !

TEST_CASE("wrap_reverse_column") {
    ...
    REQUIRE_MESSAGE(size.height == 31.0f, "height of node ", Debug(node0), ". Expected ", 31.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 70.0f, "x of node ", Debug(node0), ". Expected ", 70.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.height == 32.0f, "height of node ", Debug(node1), ". Expected ", 32.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 70.0f, "x of node ", Debug(node1), ". Expected ", 70.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 31.0f, "y of node ", Debug(node1), ". Expected ", 31.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node2).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 30.0f, "width of node ", Debug(node2), ". Expected ", 30.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 33.0f, "height of node ", Debug(node2), ". Expected ", 33.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 70.0f, "x of node ", Debug(node2), ". Expected ", 70.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 63.0f, "y of node ", Debug(node2), ". Expected ", 63.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node3).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 30.0f, "width of node ", Debug(node3), ". Expected ", 30.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 34.0f, "height of node ", Debug(node3), ". Expected ", 34.0f, ". Actual ", size.height);
