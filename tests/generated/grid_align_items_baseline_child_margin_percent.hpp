...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_items_baseline_child_margin_percent.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_items_baseline_child_margin_percent") {
    ...
    const auto node10 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.margin = Rect<LengthPercentageAuto> { LengthPercentageAuto::Percent(0.01f), LengthPercentageAuto::Percent(0.01f), LengthPercentageAuto::Percent(0.01f), LengthPercentageAuto::Percent(0.01f) };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(location.y == 70.0f, "y of node ", Debug(node1), ". Expected ", 70.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(location.x == 1.0f, "x of node ", Debug(node10), ". Expected ", 1.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 1.0f, "y of node ", Debug(node10), ". Expected ", 1.0f, ". Actual ", location.y);
}
