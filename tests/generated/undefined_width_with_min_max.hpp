...
// ATTENTION: GENERATED FROM: taffy/tests/generated/undefined_width_with_min_max.rs ! DO NOT EDIT BY HAND !

TEST_CASE("undefined_width_with_min_max") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.min_size = Size<Dimension> { Dimension::Length(0.0f), Auto<Dimension>() };
