...
// ATTENTION: GENERATED FROM: taffy/tests/generated/align_baseline_child_margin_percent.rs ! DO NOT EDIT BY HAND !

TEST_CASE("align_baseline_child_margin_percent") {
    ...
    REQUIRE_MESSAGE(location.y == 45.0f, "y of node ", Debug(node1), ". Expected ", 45.0f, ". Actual ", location.y);
