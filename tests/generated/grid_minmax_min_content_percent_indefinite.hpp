...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_min_content_percent_indefinite.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_min_content_percent_indefinite") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { minmax<TrackSizingFunction>(min_content<MinTrackSizingFunction>(), percent<MaxTrackSizingFunction>(0.2f)) };}),
            mkVec(node0)
        )
        .unwrap();
