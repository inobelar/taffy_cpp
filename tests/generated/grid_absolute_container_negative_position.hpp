...
TEST_CASE("grid_absolute_container_negative_position") {
    ...
    REQUIRE_MESSAGE(location.x == 195.0f, "x of node ", Debug(node0), ". Expected ", 195.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == -35.0f, "x of node ", Debug(node1), ". Expected ", -35.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 185.0f, "y of node ", Debug(node1), ". Expected ", 185.0f, ". Actual ", location.y);
