...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_negative_position.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_negative_position") {
    ...
    REQUIRE(location.x == 195.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node0, 195.0f, location.x
    ...
    REQUIRE(location.x == -35.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, -35.0f, location.x
    REQUIRE(location.y == 185.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 185.0f, location.y
