...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_top_right_margin.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_top_right_margin") {
    ...
    REQUIRE_MESSAGE(location.x == 178.0f, "x of node ", Debug(node0), ". Expected ", 178.0f, ". Actual ", location.x);
