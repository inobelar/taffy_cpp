...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_min_content_flex_row.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_min_content_flex_row") {
    ...
    REQUIRE_MESSAGE(size.height == 40.0f, "height of node ", Debug(node02), ". Expected ", 40.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 40.0f, "x of node ", Debug(node02), ". Expected ", 40.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 0.0f, "y of node ", Debug(node02), ". Expected ", 0.0f, ". Actual ", location.y);
}
