/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/rounding_fractial_input_5.rs !
...
TEST_CASE("rounding_fractial_input_5") {
    ...
    REQUIRE_MESSAGE(size.width == 963.0f, "width of node ", Debug(node), ". Expected ", 963.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 101.0f, "width of node ", Debug(node0), ". Expected ", 101.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 100.0f, "height of node ", Debug(node0), ". Expected ", 100.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 381.0f, "x of node ", Debug(node0), ". Expected ", 381.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 482.0f, "x of node ", Debug(node1), ". Expected ", 482.0f, ". Actual ", location.x);
