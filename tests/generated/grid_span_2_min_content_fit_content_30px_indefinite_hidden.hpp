...
TEST_CASE("grid_span_2_min_content_fit_content_30px_indefinite_hidden") {
    ...
    REQUIRE(size.width == 70.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node, 70.0f, size.width
    ...
    REQUIRE(size.width == 70.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node2, 70.0f, size.width
