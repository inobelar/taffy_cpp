...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_span_2_min_content_fit_content_30px_indefinite_hidden.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_span_2_min_content_fit_content_30px_indefinite_hidden") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { min_content<TrackSizingFunction>(), fit_content<TrackSizingFunction>(length<LengthPercentage>(30.0f)) };}),
    ...
    REQUIRE_MESSAGE(size.width == 70.0f, "width of node ", Debug(node), ". Expected ", 70.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 70.0f, "width of node ", Debug(node2), ". Expected ", 70.0f, ". Actual ", size.width);
