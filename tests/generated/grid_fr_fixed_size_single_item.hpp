...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_fr_fixed_size_single_item.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_fr_fixed_size_single_item") {
    ...
    REQUIRE_MESSAGE(location.x == 140.0f, "x of node ", Debug(node2), ". Expected ", 140.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.height == 80.0f, "height of node ", Debug(node3), ". Expected ", 80.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 80.0f, "height of node ", Debug(node4), ". Expected ", 80.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 80.0f, "height of node ", Debug(node5), ". Expected ", 80.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 140.0f, "x of node ", Debug(node5), ". Expected ", 140.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(size.height == 80.0f, "height of node ", Debug(node6), ". Expected ", 80.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node6), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 120.0f, "y of node ", Debug(node6), ". Expected ", 120.0f, ". Actual ", location.y);
    ...
    REQUIRE_MESSAGE(size.height == 80.0f, "height of node ", Debug(node7), ". Expected ", 80.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 40.0f, "x of node ", Debug(node7), ". Expected ", 40.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 120.0f, "y of node ", Debug(node7), ". Expected ", 120.0f, ". Actual ", location.y);
    { const Layout& l = taffy.layout(node8).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE_MESSAGE(size.width == 60.0f, "width of node ", Debug(node8), ". Expected ", 60.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 80.0f, "height of node ", Debug(node8), ". Expected ", 80.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 140.0f, "x of node ", Debug(node8), ". Expected ", 140.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 120.0f, "y of node ", Debug(node8), ". Expected ", 120.0f, ". Actual ", location.y);
}
