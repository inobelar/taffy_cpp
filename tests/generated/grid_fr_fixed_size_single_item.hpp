...
TEST_CASE("grid_fr_fixed_size_single_item") {
    ...
    REQUIRE(size.height == 80.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node3, 80.0f, size.height
    ...
    REQUIRE(location.y == 120.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node6, 120.0f, location.y
    ...
    REQUIRE(size.height == 80.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node7, 80.0f, size.height
    REQUIRE(location.x == 40.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node7, 40.0f, location.x
    REQUIRE(location.y == 120.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node7, 120.0f, location.y
    { const Layout& l = taffy.layout(node8).unwrap().get(); size = l.size; location = l.location; }
    REQUIRE(size.width == 60.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node8, 60.0f, size.width
    REQUIRE(size.height == 80.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node8, 80.0f, size.height
