...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_max_content_maximum_single_item.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_max_content_maximum_single_item") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { length<TrackSizingFunction>(40.0f), minmax<TrackSizingFunction>(length<MinTrackSizingFunction>(0.0f), max_content<MaxTrackSizingFunction>()), length<TrackSizingFunction>(40.0f) };}),
