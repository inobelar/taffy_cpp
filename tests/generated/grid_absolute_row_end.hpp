...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_row_end.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_row_end") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.position = Position::Absolute();
            s.grid_row = Line<GridPlacement> { GridPlacement::Auto(), line<GridPlacement>(1) };
    ...
    REQUIRE_MESSAGE(size.height == 7.0f, "height of node ", Debug(node0), ". Expected ", 7.0f, ". Actual ", size.height);
