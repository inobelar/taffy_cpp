...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_margin_y_collapse_through_blocked_by_aspect_ratio.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_margin_y_collapse_through_blocked_by_aspect_ratio") {
    ...
    REQUIRE_MESSAGE(size.height == 65.0f, "height of node ", Debug(node), ". Expected ", 65.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.y == 55.0f, "y of node ", Debug(node2), ". Expected ", 55.0f, ". Actual ", location.y);
}
