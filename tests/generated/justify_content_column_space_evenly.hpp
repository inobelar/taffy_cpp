...
// ATTENTION: GENERATED FROM: taffy/tests/generated/justify_content_column_space_evenly.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("justify_content_column_space_evenly") {
    ...
    REQUIRE_MESSAGE(location.y == 73.0f, "y of node ", Debug(node2), ". Expected ", 73.0f, ". Actual ", location.y);
}
