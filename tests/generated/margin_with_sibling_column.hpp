...
TEST_CASE("margin_with_sibling_column") {
    ...
    REQUIRE(size.height == 45.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node0, 45.0f, size.height
    ...
    REQUIRE(size.height == 45.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node1, 45.0f, size.height
    REQUIRE(location.x == 0.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 0.0f, location.x
    REQUIRE(location.y == 55.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node1, 55.0f, location.y
}
