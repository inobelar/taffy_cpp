...
// ATTENTION: GENERATED FROM: taffy/tests/generated/margin_with_sibling_column.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("margin_with_sibling_column") {
    ...
    REQUIRE_MESSAGE(size.height == 45.0f, "height of node ", Debug(node0), ". Expected ", 45.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(size.height == 45.0f, "height of node ", Debug(node1), ". Expected ", 45.0f, ". Actual ", size.height);
    REQUIRE_MESSAGE(location.x == 0.0f, "x of node ", Debug(node1), ". Expected ", 0.0f, ". Actual ", location.x);
    REQUIRE_MESSAGE(location.y == 55.0f, "y of node ", Debug(node1), ". Expected ", 55.0f, ". Actual ", location.y);
}
