...
/*
    ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_column_fixed_width_within_range.rs !
...
TEST_CASE("grid_minmax_column_fixed_width_within_range") {
    ...
    REQUIRE_MESSAGE(location.x == 70.0f, "x of node ", Debug(node5), ". Expected ", 70.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 70.0f, "x of node ", Debug(node8), ". Expected ", 70.0f, ". Actual ", location.x);
