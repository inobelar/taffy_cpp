...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percentage_size_of_flex_basis.rs ! DO NOT EDIT BY HAND !

TEST_CASE("percentage_size_of_flex_basis") {
    auto taffy = Taffy::New();
    const auto node00 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.size = Size<Dimension> { Dimension::Percent(1.0f), Dimension::Length(100.0f) };}))
        .unwrap();
    const auto node0 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) { s.flex_basis = Dimension::Length(50.0f);}),
            mkVec(node00)
        )
        .unwrap();
