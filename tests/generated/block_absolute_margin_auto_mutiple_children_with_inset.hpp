...
// ATTENTION: GENERATED FROM: taffy/tests/generated/block_absolute_margin_auto_mutiple_children_with_inset.rs ! DO NOT EDIT BY HAND !

TEST_CASE("block_absolute_margin_auto_mutiple_children_with_inset") {
    ...
    const auto node1 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.margin = Rect<LengthPercentageAuto> { zero<LengthPercentageAuto>(), LengthPercentageAuto::Auto(), zero<LengthPercentageAuto>(), zero<LengthPercentageAuto>() };
            s.inset = Rect<LengthPercentageAuto> { LengthPercentageAuto::Length(20.0f), LengthPercentageAuto::Length(10.0f), Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>() };}))
        .unwrap();
