...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_items_baseline_child_top2.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_items_baseline_child_top2") {
    ...
    const auto node1 = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.inset = Rect<LengthPercentageAuto> { Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(5.0f), Auto<LengthPercentageAuto>() };}),
            mkVec(node10)
        )
        .unwrap();
