...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_align_items_baseline_child_multiline_no_override_on_secondline.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_align_items_baseline_child_multiline_no_override_on_secondline") {
    ...
    REQUIRE_MESSAGE(location.y == 68.0f, "y of node ", Debug(node1), ". Expected ", 68.0f, ". Actual ", location.y);
