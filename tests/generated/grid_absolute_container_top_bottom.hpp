...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_top_bottom.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_top_bottom") {
    ...
    REQUIRE_MESSAGE(size.height == 153.0f, "height of node ", Debug(node0), ". Expected ", 153.0f, ". Actual ", size.height);
