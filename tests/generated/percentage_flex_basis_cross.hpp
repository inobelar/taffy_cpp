...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percentage_flex_basis_cross.rs ! DO NOT EDIT BY HAND !

TEST_CASE("percentage_flex_basis_cross") {
    ...
    REQUIRE_MESSAGE(size.height == 250.0f, "height of node ", Debug(node0), ". Expected ", 250.0f, ". Actual ", size.height);
