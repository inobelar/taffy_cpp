...
// ATTENTION: GENERATED FROM: taffy/tests/generated/justify_content_column_center.rs ! DO NOT EDIT BY HAND !
...
TEST_CASE("justify_content_column_center") {
    ...
    REQUIRE_MESSAGE(location.y == 35.0f, "y of node ", Debug(node0), ". Expected ", 35.0f, ". Actual ", location.y);
