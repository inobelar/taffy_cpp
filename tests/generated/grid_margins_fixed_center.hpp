...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_margins_fixed_center.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_margins_fixed_center") {
    auto taffy = Taffy::New();
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            s.align_self = Some(AlignSelf::Center);
            s.justify_self = Some(JustifySelf::Center);
            s.size = Size<Dimension> { Dimension::Length(20.0f), Dimension::Length(20.0f) };
            s.margin = Rect<LengthPercentageAuto> { LengthPercentageAuto::Length(8.0f), LengthPercentageAuto::Length(4.0f), LengthPercentageAuto::Length(2.0f), LengthPercentageAuto::Length(6.0f) };}))
        .unwrap();
    ...
    REQUIRE(location.y == 18.0f); // TODO: message: "y of node {:?}. Expected {}. Actual {}", node0, 18.0f, location.y
