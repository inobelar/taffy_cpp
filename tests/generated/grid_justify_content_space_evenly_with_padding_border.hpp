...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_justify_content_space_evenly_with_padding_border.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_justify_content_space_evenly_with_padding_border") {
    ...
    REQUIRE(location.x == 134.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 134.0f, location.x
    ...
    REQUIRE(location.x == 134.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node5, 134.0f, location.x
    ...
    REQUIRE(location.x == 134.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node8, 134.0f, location.x
