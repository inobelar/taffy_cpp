...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_absolute_container_top_bottom_margin.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_absolute_container_top_bottom_margin") {
    ...
    const auto node0 = taffy
        .new_leaf(StyleBuilder([&](Style& s) {
            ...
            s.inset = Rect<LengthPercentageAuto> { Auto<LengthPercentageAuto>(), Auto<LengthPercentageAuto>(), LengthPercentageAuto::Length(2.0f), LengthPercentageAuto::Length(5.0f) };}))
        .unwrap();
    ...
    REQUIRE_MESSAGE(size.height == 149.0f, "height of node ", Debug(node0), ". Expected ", 149.0f, ". Actual ", size.height);
