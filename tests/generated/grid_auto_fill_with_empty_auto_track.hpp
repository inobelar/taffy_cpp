...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_auto_fill_with_empty_auto_track.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_auto_fill_with_empty_auto_track") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.grid_template_columns = GridTrackVec<TrackSizingFunction> { repeat(GridTrackRepetition::AutoFill(), Vec<NonRepeatedTrackSizingFunction>{ length<NonRepeatedTrackSizingFunction>(40.0f) } ) };
