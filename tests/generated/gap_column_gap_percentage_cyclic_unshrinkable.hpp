...
TEST_CASE("gap_column_gap_percentage_cyclic_unshrinkable") {
    ...
    REQUIRE(location.x == 32.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node1, 32.0f, location.x
    ...
    REQUIRE(location.x == 64.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 64.0f, location.x
