...
// ATTENTION: GENERATED FROM: taffy/tests/generated/gap_column_gap_percentage_cyclic_unshrinkable.rs ! DO NOT EDIT BY HAND !

TEST_CASE("gap_column_gap_percentage_cyclic_unshrinkable") {
    ...
    REQUIRE_MESSAGE(location.x == 32.0f, "x of node ", Debug(node1), ". Expected ", 32.0f, ". Actual ", location.x);
    ...
    REQUIRE_MESSAGE(location.x == 64.0f, "x of node ", Debug(node2), ". Expected ", 64.0f, ". Actual ", location.x);
