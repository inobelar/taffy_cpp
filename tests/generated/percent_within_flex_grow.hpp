...
TEST_CASE("percent_within_flex_grow") {
    ...
    REQUIRE(size.width == 350.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node, 350.0f, size.width
    ...
    REQUIRE(size.width == 150.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node1, 150.0f, size.width
    ...
    REQUIRE(size.width == 150.0f); // TODO: message: "width of node {:?}. Expected {}. Actual {}", node10, 150.0f, size.width
    REQUIRE(size.height == 0.0f); // TODO: message: "height of node {:?}. Expected {}. Actual {}", node10, 0.0f, size.height
    ...
    REQUIRE(location.x == 250.0f); // TODO: message: "x of node {:?}. Expected {}. Actual {}", node2, 250.0f, location.x
