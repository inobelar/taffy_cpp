...
// ATTENTION: GENERATED FROM: taffy/tests/generated/percent_within_flex_grow.rs ! DO NOT EDIT BY HAND !

TEST_CASE("percent_within_flex_grow") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                s.size = Size<Dimension> { Dimension::Length(350.0f), Dimension::Length(100.0f) };}),
    ...
    REQUIRE_MESSAGE(size.width == 350.0f, "width of node ", Debug(node), ". Expected ", 350.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 150.0f, "width of node ", Debug(node1), ". Expected ", 150.0f, ". Actual ", size.width);
    ...
    REQUIRE_MESSAGE(size.width == 150.0f, "width of node ", Debug(node10), ". Expected ", 150.0f, ". Actual ", size.width);
    REQUIRE_MESSAGE(size.height == 0.0f, "height of node ", Debug(node10), ". Expected ", 0.0f, ". Actual ", size.height);
    ...
    REQUIRE_MESSAGE(location.x == 250.0f, "x of node ", Debug(node2), ". Expected ", 250.0f, ". Actual ", location.x);
