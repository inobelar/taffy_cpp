...
// ATTENTION: GENERATED FROM: taffy/tests/generated/grid_minmax_column_fixed_width_below_range.rs ! DO NOT EDIT BY HAND !

TEST_CASE("grid_minmax_column_fixed_width_below_range") {
    ...
    const auto node = taffy
        .new_with_children(
            StyleBuilder([&](Style& s) {
                ...
                s.size = Size<Dimension> { Dimension::Length(90.0f), Auto<Dimension>() };}),
    ...
    REQUIRE_MESSAGE(size.width == 90.0f, "width of node ", Debug(node), ". Expected ", 90.0f, ". Actual ", size.width);
